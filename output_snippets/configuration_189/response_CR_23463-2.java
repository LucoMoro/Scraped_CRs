...
private static final int GPS_DELETE_UNKNOWN = 0x10000; // Additional flag for the 21st category
...
public void updateFlags(Bundle extras) {
    int flags = 0;
    ...
    if (extras.getBoolean("unknown")) flags |= GPS_DELETE_UNKNOWN; // Support for the additional category

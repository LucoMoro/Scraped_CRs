...
final Context context, final Message msg) {
    new AlertDialog.Builder(context)
        .setIcon(R.drawable.ic_alert_ico) // Replace with appropriate ICS alert icon
        .setMessage(context.getString(R.string.delete_bookmark_warning, title))

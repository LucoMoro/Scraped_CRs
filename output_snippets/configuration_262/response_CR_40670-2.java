...
// Implement retry logic if max retries reached with comprehensive error handling
if (apnContext.getRetryCount() >= MAX_RETRY_COUNT) {
    ...
    if (lastErrorCode == 400 || lastErrorCode == 500 || lastErrorCode == 503 || lastErrorCode == 504) {

...
*/
private boolean insertCellBroadcast(CellBroadcastMessage message) {
    SQLiteDatabase db = mOpenHelper.getWritableDatabase();
    ContentValues cv = message.getContentValues();

    // Retrieve duplicate detection property
    boolean isDupDetectionEnabled = !System.getProperty("persist.cb.dup_detection", "true").equalsIgnoreCase("false");

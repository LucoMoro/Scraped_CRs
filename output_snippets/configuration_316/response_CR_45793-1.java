...
String persistCbDupDetection = System.getProperty("persist.cb.dup_detection");
boolean isDupDetectionEnabled = (persistCbDupDetection != null && "true".equalsIgnoreCase(persistCbDupDetection));

if (!isDupDetectionEnabled) {
    Log.d(TAG, "Duplicate detection is disabled, skipping database insert.");
    return false;
}

...
return;
        ...
        // Read system property to determine if duplicate detection is enabled
        boolean isDupDetectionEnabled = Boolean.parseBoolean(System.getProperty("persist.cb.dup_detection", "true"));
        Log.d(TAG, "Duplicate detection is " + (isDupDetectionEnabled ? "enabled" : "disabled"));

...
public void controlOperatorSelectionMenu() {
    ...
    if (efCSPData == null) {
        Log.e(LOG_TAG, "Error reading EF_CSP data");
        return;
    }

    int bitSignificant = efCSPData[0] & 0xC0; // Check the most significant bit
    if ((bitSignificant & VALUE_ADDED_SERVICES_GROUP) != 0) {

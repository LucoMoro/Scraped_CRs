...
generateCertificates_Empty(f);
    ...
    // Secure logging mechanism should be implemented here instead of printing stack trace
...
private void generateCertificates_X509_DER(CertificateFactory f) throws Exception {
    ...
    Collection<? extends Certificate> certsGenerated = null;
    try {
        certsGenerated = f.generateCertificates(is);
    ...
    assertNotNull(certsGenerated);
    assertEquals(0, certsGenerated.size());
}

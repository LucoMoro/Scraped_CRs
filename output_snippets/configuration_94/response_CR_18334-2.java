...
void exitEmergencyCallbackMode(Handler h, int what, Object obj);
//<End of snippet n. 0>
...
protected static final int EVENT_EXIT_EMERGENCY_CALLBACK_MODE = 26;
...
case RIL_UNSOL_EXIT_EMERGENCY_CALLBACK_MODE:
    ...
    if (mIsPhoneInEcmState) {
        ...
        logExitEmergencyCallbackModeSuccess();
        if (mEcmExitRespRegistrant != null) {
            mEcmExitRespRegistrant.notifyRegistrant();
        }
    } else {
        logExitEmergencyCallbackModeFailure();
    }
    break;

...
public void test_SSLSocket_getEnabledCipherSuites() throws Exception {
    // <Your existing method content>
}

// Log the errors if there were any at the end of all connection attempts
if (error.length() != 0) {
    System.out.println("One or more problems in test_SSLSocket_getSupportedCipherSuites_connect:\n" + error);
}
c.close();
//<End of snippet n. 0>
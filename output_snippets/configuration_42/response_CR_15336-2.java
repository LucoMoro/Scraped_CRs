...
public class FsUtils {
    ...
    static final String HTTP_TESTS_PREFIX = "/android/layout_tests/http/tests/";
    static final String HTTPS_TESTS_PREFIX = "/android/layout_tests/http/tests/ssl/";
    static final String HTTP_LOCAL_TESTS_PREFIX = "/android/layout_tests/http/tests/local/";
    static final String HTTP_MEDIA_TESTS_PREFIX = "/android/layout_tests/http/tests/media/";
    static final String HTTP_WML_TESTS_PREFIX = "/android/layout_tests/http/tests/wml/";
    ...
    public static String getPath(String subpath) {
        return Environment.getExternalStorageDirectory().getPath() + subpath;
    }
}
//<End of snippet n. 1>
...
public class MyTestRecorder {
    ...
    static final String LAYOUT_TESTS_ROOT = "/android/layout_tests/";
    static final String LAYOUT_TESTS_RESULT_DIR = "/android/layout_tests_results/";
    static final String ANDROID_EXPECTED_RESULT_DIR = "/android/expected_results/";
    static final String LAYOUT_TESTS_LIST_FILE = "/android/layout_tests_list.txt";
    static final String TEST_STATUS_FILE = "/android/running_test.txt";
...
public class LoadTestsAutoTest extends ActivityInstrumentationTestCase2<TestShellActivity> {
    ...
    private static final String LOAD_TEST_RESULT = "/load_test_result.txt";
...
public class ReliabilityTest {
    ...
    private static final String TEST_LIST_FILE = "/android/reliability_tests_list.txt";
    private static final String TEST_STATUS_FILE = "/android/reliability_running_test.txt";
    private static final String TEST_TIMEOUT_FILE = "/android/reliability_timeout_test.txt";
    private static final String TEST_LOAD_TIME_FILE = "/android/reliability_load_time.txt";
...
public class ImageUtils {
    ...
    static final String DRAW_TIME_LOG = "/android/page_draw_time.txt";
...
public class ForwardService {
    ...
    private static final String FORWARD_HOST_CONF = "/drt_forward_host.txt";
...
public class LocationTracker {
    private String getUniqueFileName(String ext) {
        ...
        return Environment.getExternalStorageDirectory().getPath() + "/locationtracker/tracking-" + DateUtils.getCurrentTimestamp() + "." + ext;
    }

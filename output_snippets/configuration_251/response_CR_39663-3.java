...
mShell.setMenuBar(menuBar);
        ...
        configureDevice.setText("Configure Devices...");
...
private void openDeviceConfigurationDialog() {
    // Logic to open the device configuration dialog
    try {
        // Implementation here
    } catch (Exception e) {
        mUpdaterData.getSdkLog().error(e, "Failed to open device configuration dialog");
    }
}

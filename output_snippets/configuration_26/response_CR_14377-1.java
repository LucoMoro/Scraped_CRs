...
public class InstrumentationTest extends InstrumentationTestCase {
    ...
    for (int i = 0; i < keyDownList.size(); i++) {
        assertEquals(sendStringSync(String.valueOf(text.charAt(i))).charAt(0), keyDownList.get(i).getKeyCode());
    }

    for (int i = 0; i < keyUpList.size(); i++) {
        assertEquals(sendStringSync(String.valueOf(text.charAt(i))).charAt(0), keyUpList.get(i).getKeyCode());
    }
}
...
assertEquals('\0', mKeyCharacterMap.getMatch(sendStringSync("E"), chars));
assertEquals(sendStringSync("A").charAt(0), mKeyCharacterMap.getMatch(sendStringSync("A"), chars));
assertEquals(sendStringSync("B").charAt(0), mKeyCharacterMap.getMatch(sendStringSync("B"), chars));
}
...
assertEquals('\0', mKeyCharacterMap.getMatch(sendStringSync("E"), chars, 0));
assertEquals(sendStringSync("A").charAt(0), mKeyCharacterMap.getMatch(sendStringSync("A"), chars, 0));
assertEquals(sendStringSync("B").charAt(0), mKeyCharacterMap.getMatch(sendStringSync("B"), chars, 0));
}

...
private void assertCanBeHandled(Intent intent) {
    ...
    if (resolveInfos.isEmpty()) {
        Log.e(TAG, "Intent cannot be handled: " + intent.toString());
    }
...
public void testDialPhoneNumber() {
    if (getContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_TELEPHONY)) {
        ...
        Log.i(TAG, "Skipped testDialPhoneNumber: Device does not support telephony.");
        // Alternative actions can be defined here if applicable
    }
}
...
public void testDialVoicemail() {
    if (getContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_TELEPHONY)) {
        ...
        Log.i(TAG, "Skipped testDialVoicemail: Device does not support telephony.");
        // Alternative actions can be defined here if applicable
    }
}

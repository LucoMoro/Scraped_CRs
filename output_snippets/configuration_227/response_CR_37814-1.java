...
debugInfo += (contents.debugInfos != null ? contents.debugInfos.byteCount : 0);
...
code += (int) Math.ceil(contents.codes.byteCount * 1.25) + debugInfo;
// at least 1/4 of the bytes in a code section are uleb/sleb

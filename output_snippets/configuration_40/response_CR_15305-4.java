...
private void parseRecord(byte[] record) {
    try {
        ...
        // Additional logic to handle KSC5601 encoding
        if (alphaTag.isEmpty() && isKSC5601Encoded(record, footerOffset)) {
            alphaTag = IccUtils.adnStringFieldToStringKSC5601(record, 0, footerOffset);
        }
...
public class SmsMessage extends SmsMessageBase {
    ...
    private String decodeKSC5601(byte[] data, int offset, int length) {
        ...
        return new String(data, offset, length, StandardCharsets.UTF_16); // Placeholder for actual decoding logic
    }
}
//<End of snippet n. 3>
...
public String getAdapterItemValue(ResourceReference adapterView, ResourceReference itemRef,
    ...
    if (fullPosition < 0 || typePosition < 0) {
    ...
    switch (viewClass) {
        ...
        case "ImageView":
            return "Image: " + viewRef.getName();
        case "Button":
            return "Button: " + viewRef.getName();
        case "ProgressBar":
            return "Progress: " + viewRef.getName();
        case "CheckBox":
            return "CheckBox: " + viewRef.getName();
        default:
            throw new UnsupportedOperationException("Unsupported view class: " + viewClass);
    }
}
...
public AdapterBinding getAdapterBinding(ResourceReference adapterView) {
    ...
    AdapterBinding binding = createAdapterBinding(adapterView);

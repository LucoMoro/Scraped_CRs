 ...
 *
 * @param key the value to get, must match a valid entry in mValues
 * @return the data for the value, or null if the key is missing or if the type conversion fails
 */

...
public class SystraceOptionsDialog extends TitleAreaDialog {
    ...
    public void detectAtraceVersion() throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()))) {
            ...
            throw new IOException("Failed to detect atrace version", e);
        }
    }
    ...
    private String determineVersion(String output) {
        // Logic to determine the atrace version based on output structure
        return "newer"; // Placeholder logic
    }

...
private boolean isMarkupElement(Element element) {
    // Updated to handle a broader range of HTML tags.
    String tagName = element.getTagName().toLowerCase();
    List<String> allowedTags = Arrays.asList("b", "i", "u", "s", "div", "span", "p", "strong", "em");
    return mStyle == XmlFormatStyle.RESOURCE && allowedTags.contains(tagName);
}

/**
 * Additional methods to handle nested HTML elements, comments, and CDATA sections.
 */

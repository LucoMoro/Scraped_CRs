...
private boolean isNTTDOCOMO() {
    if (mTelephonyManager != null) {
        return mTelephonyManager.getNetworkOperator().startsWith("440");
    }
    return false;
}
...
private void sendDataSMS() throws Exception {
    ...
    try {
        ...
        Log.e("SMS", "Error sending data SMS: " + e.getMessage());
    }
}
...
private void sendMultiPartSMS() throws Exception {
    ...
    try {
        ...
        Log.e("SMS", "Error sending multi-part SMS: " + e.getMessage());
    }
}

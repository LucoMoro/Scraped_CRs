...
private String getValidPackageName() {
    ...
    while (retries > 0) {
        try {
            ...
            if (packages != null && !packages.isEmpty()) {
                ...
                return validateFallbackPackageName(HOME_PACKAGE_NAME); // Validating fallback package name
            }
    ...
    Log.e(TAG, "Could not retrieve installed packages after multiple attempts.");
    return validateFallbackPackageName(HOME_PACKAGE_NAME); // Validating fallback package name
}

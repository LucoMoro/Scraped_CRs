...
public enum FailCause {
    ...
    public static FailCause getFailCauseFromSystemProperty() {
        ...
        if (tmpFailures != null) {
            // Example parsing logic, should be replaced with actual conditions
            if (tmpFailures.contains("some_specific_failure")) {
                return FailCause.OPERATOR_BARRED; // Example mapping
            }
        }
        return UNKNOWN; 
    }
...
public void handleFailure(AsyncResult ar) {
    ...
    if (ar.exception == null) {
        ...
        EventLog.writeEvent(EventLogTags.DATA_CONNECTION_FAILURE, cause.ordinal()); // Enhanced logging
    }
}

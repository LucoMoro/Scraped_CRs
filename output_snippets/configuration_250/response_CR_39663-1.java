...
private void createMenuBar() {
    ...
    try {
        ...
        mUpdaterData.getSdkLog().error("Failed to setup menu bar securely");
    }
}

private void onConfigureDevices() {
    // Logic to configure devices, implement as needed
}

private void onCreateDevice() {
    // Logic to create a device, implement as needed
}
//<End of snippet n. 0>
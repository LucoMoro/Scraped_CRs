...
private void createMenuBar() {
    ...
    try {
        ...
        if (mUpdaterData != null) {
            mUpdaterData.getSdkLog().error(null, "Failed to setup menu bar");
        }
    }
}

private void onConfigureDevices() {
    // Add logic to configure devices, for example:
    // Load available devices and present options to the user
}

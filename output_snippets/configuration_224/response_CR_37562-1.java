...
if (messageIdentifier == ETWS_MESSAGE_IDENTIFIER) {
...
} else if (isValidGSMMessageIdentifier(messageIdentifier)) {
    format = FORMAT_GSM;
    ...
    throw new IllegalArgumentException("Unknown message identifier: " + messageIdentifier);
}
//<End of snippet n. 0>
...
if (topLevelSampleDir.isDirectory() && new File(topLevelSampleDir, SdkConstants.FN_ANDROID_MANIFEST_XML).isFile()) {
...
private void processManifestFile(File dir, IAndroidTarget targetVersion, List<Pair<String, File>> samples) {
    ...
    try {
        ...
        if (data != null) {
            ...
            if (accept) {
                String name = getSampleDisplayName(name, currDir, dir);

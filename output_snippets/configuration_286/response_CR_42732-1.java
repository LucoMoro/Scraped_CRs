...
if (f.isDirectory()) {
                // Check if it is a "sample" directory without a manifest.
...
private void validatePage() {
    ...
    // Check for the "sample" directory specifically
    File sampleDir = new File(a.getLocalOsPath(), SdkConstants.FD_EXTRAS + "/sample");
    if (sampleDir.isDirectory()) {
        samples.put(sampleDir, pkg.getListDescription());
    }
}
...
// Removed as it was not necessary with the handling already in place

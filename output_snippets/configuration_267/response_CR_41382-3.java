...
try {
    ...
    if (cursor != null && cursor.moveToFirst()) {
        ...
        if (delta >= MAX_CONCATENATED_SEGMENT_TIME) {
            deleteAllSegments(refNumber);
            return Intents.RESULT_SMS_HANDLED;
        }
...
private void deleteAllSegments(String refNumber) {
    String where = "reference_number=?";
    mResolver.delete(mRawUri, where, new String[]{refNumber});
}

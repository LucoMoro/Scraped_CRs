...
public class ListViewTypeMenu extends SubmenuAction {
    ...
    @Override
    public void run() {
        // Add GridView option handling here
        ...
        action = new SetListTypeAction("Simple 2-Line Expandable List Item",
                ...
                selected);
        new ActionContributionItem(action).fill(menu, -1);
        action = new SetListTypeAction("Grid Item",
                "simple_grid_item", //$NON-NLS-1$
                selected);
        new ActionContributionItem(action).fill(menu, -1);
        ...
        addDisabledMessageItem("GridView not applicable");
    }
}
//<End of snippet n. 6>
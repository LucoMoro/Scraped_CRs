    ...
    if (folders != null) {
        ...
        for (File folder : folders) {
            ...
            if (folderName.startsWith(DRAWABLE_FOLDER)) {
                ...
                if (containsMixedDrawables(folder, context)) {
                    context.report(ICON_EXTENSION, folder, context.getLocation(folder), "Mixed drawable types found in folder: " + folder.getAbsolutePath());
                }
            }
...
private boolean containsMixedDrawables(File folder, Context context) {

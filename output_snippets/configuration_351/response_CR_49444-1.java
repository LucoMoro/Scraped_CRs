...
public void updateToolItems() {
    ...
    mTBShowHeapUpdates.setEnabled(mCurrentClient != null);
    mTBHalt.setEnabled(mCurrentClient != null);
    mTBCauseGc.setEnabled(mCurrentClient != null);
    mTBProfiling.setEnabled(mCurrentClient != null);
...
public void toggleMethodProfiling() {
    if (mCurrentClient != null) {
        ...
        System.err.println("Error: No current client available for profiling.");
    }
}
//<End of snippet n. 4>
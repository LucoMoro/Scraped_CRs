...
public class SensorFeaturesTest extends AndroidTestCase {
    ...
    private void assertFeatureForSensor(Set<String> featuresLeft, String expectedFeature, int expectedSensorType) {
        ...
        String message = "PackageManager#hasSystemFeature(" + expectedFeature + ") returns " + hasSensorFeature + " but SensorManager#getSensorList(" + expectedSensorType + ") shows sensors " + sensors;
...
public class TelephonyFeaturesTest extends AndroidTestCase {
    ...
    private void assertTelephonyFeatures(String... expectedFeaturesEnabled) {
        ...
        Collections.addAll(disabledFeatures, PackageManager.FEATURE_TELEPHONY, PackageManager.FEATURE_TELEPHONY_GSM, PackageManager.FEATURE_TELEPHONY_CDMA);

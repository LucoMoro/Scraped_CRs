...
if (!Arrays.equals(oldPdu, pdu)) {
    ...
    deleteSegmentsByReference(refNumber);
...
// Assume deleteSegmentsByReference is a defined method that deletes segments
private void deleteSegmentsByReference(String referenceNumber) {
    String deleteWhere = "reference_number=?";
    String[] deleteWhereArgs = new String[] {referenceNumber};

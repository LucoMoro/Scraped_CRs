...
if (isSimLockEnabled()) {
    ...
    return; // Exit early to avoid appending additional messages
}
...
if (err == CommandException.Error.REQUEST_NOT_SUPPORTED) {
    ...
    sb.append(context.getText(com.android.internal.R.string.passwordIncorrect)); // Only append this if no specific error occurred
}
//<End of snippet n. 0>

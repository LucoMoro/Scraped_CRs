...
try {
    ...
    System.err.println("Error loading proxy configuration: " + e.getMessage());
...
private boolean isValidProxyAddress(String proxyAddress) {
    // Simple regex to validate IP or hostname, could be enhanced further
    return proxyAddress.matches("^(?:[0-9]{1,3}\\.){3}[0-9]{1,3}$") || proxyAddress.matches("^[a-zA-Z0-9._-]+$");
}
<<End of snippet n. 0>>
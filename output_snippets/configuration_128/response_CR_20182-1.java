...
public class BluetoothActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isAirplaneModeOn() && !canBluetoothWorkInAirplaneMode()) {
    ...
    private boolean canBluetoothWorkInAirplaneMode() {
        ...
        int airplaneModeSetting = Settings.Global.getInt(this.getContentResolver(), Settings.Global.AIRPLANE_MODE_ON, 0);
        return bluetoothSetting == 1 && airplaneModeSetting == 0;
    }

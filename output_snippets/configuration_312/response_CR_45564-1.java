...
int RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED = 1002;
int RIL_UNSOL_RESPONSE_BASE = 1000;
int RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED = 1003;
...
public class SmsConstants {
    public static final int FORMAT_UNKNOWN = -1; // Added FORMAT_UNKNOWN constant
}

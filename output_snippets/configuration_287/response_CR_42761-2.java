...
private static final List<DevicesChangeListener> listeners = Collections.synchronizedList(new ArrayList<DevicesChangeListener>());
...
public List<Device> getUserDevices() {
    synchronized (sLock) {
        ...
        return mUserDevices; // placeholder, assumes mUserDevices is populated somewhere
    }
}

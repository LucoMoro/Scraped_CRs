...
// Initialization of the scrollbar minimum and maximum values
...
mMaxScrollValue = mMaxMessages; // Update based on current max messages
}
...
return (scrollPosition >= mMaxScrollValue - 5); // Adjustable threshold
}

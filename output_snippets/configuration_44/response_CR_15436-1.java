...
// State preservation
private CanvasViewInfo mSavedSelectedNode;
private List<TreePath> mSavedExpandedPaths;
...
if (mOutline1 != null && mGraphicalEditor != null) {
    // Preserve the selected and expanded states
    mSavedSelectedNode = mOutline1.getSelectedNode();
    mSavedExpandedPaths = mOutline1.getExpandedPaths();
    
    mOutline1.reloadModel();

    // Restore the selected and expanded states
    mOutline1.setSelectedNode(mSavedSelectedNode);
    mOutline1.setExpandedPaths(mSavedExpandedPaths);
}
...
public class OutlinePage2 implements IContentOutlinePage {
    ...
    public CanvasViewInfo getSelectedNode() {
        // Logic to get selected node
    }
    
    public void setSelectedNode(CanvasViewInfo node) {
        // Logic to set selected node
    }

    public List<TreePath> getExpandedPaths() {
        // Logic to get expanded paths
    }
    
    public void setExpandedPaths(List<TreePath> paths) {
        // Logic to set expanded paths
    }

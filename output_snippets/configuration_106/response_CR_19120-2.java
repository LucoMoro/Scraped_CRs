...
public Object getEditableValue() {
    return mName; // Return name for the editable value
}
//<End of snippet n. 0>
...
*          
* @param scene    the LayoutScene being rendered
* @param explodedNodes the Set of exploded nodes
*/
public void setResult(LayoutScene scene, Set<UiElementNode> explodedNodes) {
    ...
    mIsResultValid = (scene.getResult().getStatus() == SceneResult.LayoutStatus.SUCCESS);
...
/**
* This can be reset to a new instance every time {@link #render()} is called 
* and can be <code>null</code> if the call failed (and the method returned a 
* {@link SceneResult} with {@link LayoutStatus#ERROR} or {@link LayoutStatus#NOT_IMPLEMENTED}).
...
/**
* The animation playback is asynchronous and the rendered frame is sent via the
* <var>listener</var>.
*
* @return a {@link SceneResult} indicating the status of the action.
*/

...
public synchronized CanvasViewInfo getParent() {
    return mParent;
}

public synchronized void setParent(CanvasViewInfo parent) {
    mParent = parent;
}

public synchronized void addChild(CanvasViewInfo child) {
    mChildren.add(child);
}

public synchronized void removeChild(CanvasViewInfo child) {
...
public SceneResult getResult() {
    return new SceneResult(LayoutStatus.ERROR, "Not implemented");
}

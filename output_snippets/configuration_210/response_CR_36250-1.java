...
private void checkDeviceConnection() {
    if (mCurrentDevice == null) {
        Log.d("LogCatReceiver", "Current device is null.");
        return;
    }
...
private void logDeviceDisconnection() {
    String deviceId = mCurrentDevice.getDeviceId(); // Assume getDeviceId() method exists
    String deviceName = mCurrentDevice.getDeviceName(); // Assume getDeviceName() method exists

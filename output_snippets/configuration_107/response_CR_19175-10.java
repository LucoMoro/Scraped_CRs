...
public class AvdManagerAction implements IWorkbenchWindowActionDelegate, IObjectActionDelegate {
    ...
    public void run(IAction action) {
        ...
        if (sdk != null) {
            ...
            AdtPlugin.displayError("Invalid SDK", "Please check that the SDK location is set correctly and the path is valid.");
        }
    }
    ...
    private Shell getShell() {
        IWorkbenchWindow window = AdtPlugin.getWorkbench().getActiveWorkbenchWindow();

...
public class KeyStoreTest extends ActivityUnitTestCase<Activity> {
    ...
    private static final String PUBLIC_ISSUE_KEYNAME = "testkey";
    private static final String PUBLIC_ISSUE_KEYNAME1 = "testkey1";
    private static final String PUBLIC_ISSUE_KEYNAME2 = "testkey2";
    ...
    public void testDelete() throws Exception {
        assertTrue(mKeyStore.delete(PUBLIC_ISSUE_KEYNAME));
        mKeyStore.password(TEST_PASSWD);
        assertTrue(mKeyStore.delete(PUBLIC_ISSUE_KEYNAME));

        mKeyStore.put(PUBLIC_ISSUE_KEYNAME, TEST_KEYVALUE);
        assertTrue(Arrays.equals(TEST_KEYVALUE, mKeyStore.get(PUBLIC_ISSUE_KEYNAME)));
    }
}
//<End of snippet n. 0>
...
try {
    ...
    // Additional logging for preference change errors can be added here
}
//<End of snippet n. 1>
...
if (enableChannel50Alerts) {
    ...
    // Trigger the modem configuration update on preference change
    setConfigBroadcastMessages(); 
}
//<End of snippet n. 2>
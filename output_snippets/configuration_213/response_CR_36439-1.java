...
import org.eclipse.swt.widgets.GridLayout;
...
public class LogCatMonitorDialog extends TitleAreaDialog {
    ...
    protected Control createDialogArea(Composite shell) {
        ...
        levelCombo.select(2); // Default to INFO
    ...
    protected void okPressed() {
        // Add handling for OK button to store user choice
        super.okPressed();
    }

    @Override
    protected void cancelPressed() {
        // Add handling for Cancel button if necessary
        super.cancelPressed();
    }

...
if (args.length >= 3 && args[0].equals("ping")) {
    ...
    Logger.getLogger(SdkStatsService.class.getName()).warning("Unknown argument: " + args[0]);
}
//<End of snippet n. 0>
...
private void actuallySendPing(String app, String version, long id)
    ...
    if (responseCode != HttpURLConnection.HTTP_OK &&
        ...
        throw new IOException("Unexpected response: " + responseCode + ": " + url);    
    }
}
...
private String normalizeVersion(String app, String version) {
    ...
    return version; // Ensure proper return of normalized version.
}
//<End of snippet n. 1>

...
} else if (isShortCode(dialString, phone) && !isTwoDigitCode(dialString)) {
// this may be a short code, as defined in TS 22.030, 6.5.3.2
ret = new GsmMmiCode(phone);
}

private boolean isTwoDigitCode(String dialString) {
    return dialString.length() == 2 && dialString.matches("[9][2-6]");
}

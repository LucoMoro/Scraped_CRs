...
if (inputStream == null) {
    throw new IOException("Failed to retrieve InputStream from URL: " + urlString);
}
return inputStream;
//<End of snippet n. 0>
...
try {
    ...
    try {
        ...
        throw new IOException("Failed to open URL with HttpClient or Url.open: " + url, e2);
    }
}
...
if (result == null) {
    ...
    InputStream inputStream = result.getFirst();
    if (inputStream == null) {
        throw new IOException("Failed to retrieve InputStream from URL: " + url);
    }
}
//<End of snippet n. 1>
...
try {
    ...
    if (is == null) {
        throw new IOException("Failed to open direct URL: " + urlString);
    }

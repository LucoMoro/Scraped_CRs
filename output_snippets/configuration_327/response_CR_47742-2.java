        ...
        try {
            ...
            if (c != null) {
                if (!verifyGraphicsProfiling()) {
                    ...
                    // Verify command execution immediately after enabling profiling
                    if (!verifyGraphicsProfiling()) {
            ...
            Log.e("GraphicsProfiling", "Error during profiling process", e);
            // Provide detailed logging or user notifications for failures
        }
    });
}
...
private boolean verifyGraphicsProfiling() {
    ...
    try {
        ...
        Log.e("GraphicsProfiling", "Error verifying graphics profiling", e);
        return false;
    }
}

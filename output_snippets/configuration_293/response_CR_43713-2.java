...
public final class CipherTest extends TestCase {
    ...
    private static String getBaseAlgorithm(String algorithm) {
        switch (algorithm) {
            ...
            case "PBEWITHSHAAND3-KEYTRIPLEDES-CBC":
                return "DESede";
            default:
                return algorithm.startsWith("RSA/") ? null : "DES";
        }
    }
    ...
    private static boolean isAsymmetric(String algorithm) {
        return "RSA".equals(getBaseAlgorithm(algorithm));
    }
    ...
    private void test_Cipher(Cipher c) throws Exception {
        ...
        if (c.getAlgorithm().startsWith("AES")) {
    ...
    private Key getEncryptKey(String algorithm) {
        // Assume implementation of key generation here
        return null; // Placeholder
    }

    private int getEncryptMode(String algorithm) {
        // Assume implementation that returns the proper encryption mode based on the algorithm
        return Cipher.ENCRYPT_MODE; // Placeholder
    }
}

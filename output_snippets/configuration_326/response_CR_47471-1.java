...
public class LocalTransport {
    ...
    public LocalTransport(Context context) {
        ...
        applyLabel(new File(Environment.getSecureDataDirectory(), "backup/backup")); // Additional labeling for backup dir
        applyLabel(new File("/cache/backup")); // Immediate labeling for cache backup
    }
    ...
    public void initialize() {
        ...
        applyLabel(new File(mCacheDir, "backup")); // Additional labeling for cache backup dir
    }
}
//<End of snippet n. 0>

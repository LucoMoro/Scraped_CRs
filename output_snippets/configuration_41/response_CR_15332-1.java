...
private static final String DEFAULT_TRACE_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + "/your_default_trace_file" + DEFAULT_TRACE_EXTENSION; // Stub provided for completeness

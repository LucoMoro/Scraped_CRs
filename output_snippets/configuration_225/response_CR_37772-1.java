...
public FindDialog(Shell shell, IFindTarget target, String defaultAction) {
    ...
    if (!"next".equals(defaultAction) && !"previous".equals(defaultAction)) {
...
protected void createButtonsForButtonBar(Composite parent) {
    ...
    mFindNext.setEnabled("next".equals(defaultAction));
    mFindPrevious.setEnabled("previous".equals(defaultAction));
}
...
mFindDialog = new FindDialog(Display.getDefault().getActiveShell(), mFindTarget, "next");

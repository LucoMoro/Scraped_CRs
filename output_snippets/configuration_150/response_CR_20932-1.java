...
RawContacts.REV + " TEXT " + // Added REV field
");");
...
+ RawContactsColumns.CONCRETE_NAME_VERIFIED + " AS " + RawContacts.NAME_VERIFIED + ","
+ RawContacts.REV + " AS " + RawContacts.REV + ","
...
sRawContactsProjectionMap.put(RawContacts.DISPLAY_NAME_PRIMARY, RawContacts.DISPLAY_NAME_PRIMARY);
...
columns.put(RawContacts.REV, RawContacts.REV); // Added REV column handling
...
values.put(RawContacts.REV, "2023-10-01T12:00:00Z"); // Added example REV value

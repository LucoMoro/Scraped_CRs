...
RawContacts.REV + " TEXT " + // Added REV field definition
");");
...
columns.put(RawContacts.REV, RawContacts.REV); // Added REV field mapping
...
values.put(RawContacts.REV, "2023-10-01T10:00:00Z"); // Added REV value for the test

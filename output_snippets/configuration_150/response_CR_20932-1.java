...
RawContactsColumns.CONCRETE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
RawContacts.SYNC1 + " TEXT, " +
RawContacts.SYNC2 + " TEXT, " +
RawContacts.SYNC3 + " TEXT, " +
RawContacts.SYNC4 + " TEXT, " +
...
+ RawContactsColumns.CONCRETE_REV + " AS " + RawContacts.REV + ","
+ RawContactsColumns.CONCRETE_VERSION + " AS " + RawContacts.VERSION + ","
+ RawContactsColumns.CONCRETE_DIRTY + " AS " + RawContacts.DIRTY + ","
...
sRawContactsProjectionMap.put(RawContacts.REV, RawContacts.REV);
...
values.put(RawContacts.REV, new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", Locale.US).format(new Date()));

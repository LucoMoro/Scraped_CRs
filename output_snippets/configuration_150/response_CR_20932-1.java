...
* </pre>
*/
    static final int DATABASE_VERSION = 354; // Updated version for REV field
...
RawContacts.REV + " TEXT " + // Added REV column
");");
...
+ RawContactsColumns.CONCRETE_DREV + " AS " + RawContacts.REV + "," // Index for REV field
...
oldVersion = 354; // Updated version for REV field
}
...
sRawContactsProjectionMap.put(RawContacts.REV, RawContacts.REV); // Added REV field
...
columns.put(RawContacts.REV, RawContacts.REV); // Added REV field
...
values.put(RawContacts.REV, "2023-10-10T10:00:00Z"); // Added dummy REV value

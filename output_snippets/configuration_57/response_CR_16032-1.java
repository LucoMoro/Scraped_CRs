...
if (intent.getAction().equals(Intent.ACTION_TETHER_STATE_CHANGED)) {
    available = intent.getStringArrayListExtra(ConnectivityManager.EXTRA_ACTIVE_TETHER).toArray(new String[0]);
    tethered = intent.getStringArrayListExtra(ConnectivityManager.EXTRA_ACTIVE_TETHER).toArray(new String[0]);
    errored = intent.getStringArrayListExtra(ConnectivityManager.EXTRA_ERRORED_TETHER).toArray(new String[0]);

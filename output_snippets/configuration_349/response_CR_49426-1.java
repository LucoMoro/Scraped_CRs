...
public static final EnumSet<Scope> OTHER_SCOPE = EnumSet.of(Scope.OTHER); // Added Other scope
}
//<End of snippet n. 5>
...
return;
        ...
        for (File otherFolder : project.getOtherFolders()) { // Added check for other folders

...
public static final EnumSet<Scope> OTHER_SCOPE = EnumSet.of(Scope.OTHER); // Added for Scope.OTHER
//<End of snippet n. 5>
...
public class PrivateKeyDetector extends Detector {
    ...
    public void afterCheckProject(@NonNull Context context) {
        ...
        for (File otherFolder : project.getOtherFolders()) { // Added for checking Scope.OTHER
    ...
    public boolean appliesTo(@NonNull Context context, @NonNull File file) {
        return OTHER_SCOPE.contains(Scope.OTHER) || isPrivateKeyFile(file);
    }

...
public static final EnumSet<Scope> OTHER_SCOPE = EnumSet.of(Scope.OTHER); // Added definition for Scope.OTHER
//<End of snippet n. 5>
...
/** Implementation should include Scope.OTHER checks */
...
// New logic to check files under Scope.OTHER
List<File> otherFiles = project.getFilesInScope(Scope.OTHER);
for (File otherFile : otherFiles) {
checkFolder(context, otherFile);
}
}
@Override

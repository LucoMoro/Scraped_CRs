...
public void afterCheckProject(@NonNull Context context) {
    ...
    for (File other : project.getFiles(Scope.OTHER_SCOPE)) {
        checkFolder(context, other);
    }
}
...
public boolean appliesTo(@NonNull Context context, @NonNull File file) {
    ...
    return context.getScope().equals(Scope.ALL_RESOURCES_SCOPE) || 
           context.getScope().equals(Scope.OTHER_SCOPE);
}

...
sSupportedContentTypes.add(IMAGE_BMP); // Added BMP support
...
sSupportedContentTypes.add(AUDIO_WAV); // Added WAV support

sSupportedImageTypes.add(IMAGE_WBMP);
sSupportedImageTypes.add(IMAGE_PNG);
sSupportedImageTypes.add(IMAGE_JPG);
sSupportedImageTypes.add(IMAGE_BMP); // Added BMP support
...
sSupportedAudioTypes.add(AUDIO_WAV); // Added WAV support

// Error handling for unsupported formats would be implemented below this point

...
private static Set<String> sSupportedContentTypes = new HashSet<>();
private static Set<String> sSupportedImageTypes = new HashSet<>();
private static Set<String> sSupportedAudioTypes = new HashSet<>();

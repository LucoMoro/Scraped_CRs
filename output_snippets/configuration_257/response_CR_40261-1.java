...
private static final Set<String> SAFE_PROVIDER_CLASSES = Set.of("com.safe.Provider1", "com.safe.Provider2"); // Add known safe classes
...
private static void loadProviders() {
    ...
    while ((providerClassName = Security.getProperty("security.provider." + i++)) != null) {
        if (!SAFE_PROVIDER_CLASSES.contains(providerClassName.trim())) {
            continue; // Skip unsafe provider classes
        }
        try {

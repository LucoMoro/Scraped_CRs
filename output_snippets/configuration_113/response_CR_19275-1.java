...
public SceneResult insertChild(Object parentView, IXmlPullParser childXml, int index) {
    if (parentView == null || childXml == null) {
        return new SceneResult("parentView or childXml cannot be null");
    }
    if (!(parentView instanceof ViewGroup)) {
        return new SceneResult("parentView must be an instance of ViewGroup");
    }
    if (index < 0) {
        return new SceneResult("Index cannot be negative");
    }
    try {
        ...
        return new SceneResult("Index out of bounds", e);
    } catch (Exception e) {
        return new SceneResult("Error inserting child", e);
    }
}
...
public SceneResult moveChild(Object parentView, IXmlPullParser layoutParamsXml, int index) {
    if (parentView == null || layoutParamsXml == null) {
        return new SceneResult("parentView or layoutParamsXml cannot be null");
    }
    if (!(parentView instanceof ViewGroup)) {
        return new SceneResult("parentView must be an instance of ViewGroup");
    }
    ...
    try {
        ...
        return new SceneResult("Error moving child", e);
    }
}
...
public SceneResult removeChild(Object parentView, int index) {
    if (parentView == null) {
        return new SceneResult("parentView cannot be null");
    }
    if (!(parentView instanceof ViewGroup)) {
        return new SceneResult("parentView must be an instance of ViewGroup");
    }
    ...
    try {
        ...
        return new SceneResult("Error removing child", e);
    }
}

/*Fix memory leak in WifiManager Root Cause: ServiceHandler in WifiManager would be hold by the channel created in AsyncServiceHandler in WifiService. Solution: Force closed when the connection is closed.

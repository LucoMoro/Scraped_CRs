...
//Synthetic comment -- index cc7774d..80813b7 100644
...
//Synthetic comment -- index 79dca39..acc5fd8 100644
...
assertTrue("updating ranges", testManager.updateRanges());
assertEquals("flags after test", ALL_FLAGS_SET, testManager.flags);
//Synthetic comment -- @@ -229,10 +239,50 @@
...
//Synthetic comment -- @@ -280,11 +330,13 @@
testManager.reset();
...
assertTrue("updating ranges", testManager.updateRanges());
assertEquals("flags after test", ALL_FLAGS_SET, testManager.flags);
//Synthetic comment -- @@ -298,13 +350,15 @@
testManager.reset();
...
assertTrue("updating ranges", testManager.updateRanges());
assertEquals("flags after test", ALL_FLAGS_SET, testManager.flags);
//Synthetic comment -- @@ -320,9 +374,13 @@
testManager.reset();
...
assertTrue("updating ranges", testManager.updateRanges());
assertEquals("flags after test", ALL_FLAGS_SET, testManager.flags);
//Synthetic comment -- @@ -336,9 +394,11 @@
testManager.reset();
...
assertTrue("updating ranges", testManager.updateRanges());
assertEquals("flags after test", ALL_FLAGS_SET, testManager.flags);
//Synthetic comment -- @@ -361,10 +421,713 @@
SMS_CB_CODE_SCHEME_MAX, true);
testManager.reset();

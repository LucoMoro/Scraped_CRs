...
//Synthetic comment -- index 4296afb..de79ade 100644
...
@Override
//Synthetic comment -- @@ -394,11 +394,11 @@
private int mYear;
...
//Synthetic comment -- @@ -456,10 +456,10 @@
...
//Synthetic comment -- @@ -479,20 +479,20 @@
mYear = 0;
mDuration = 0;
mPath = path;
            mLastModified = lastModified;
...
//Synthetic comment -- @@ -511,13 +511,13 @@
}
return false;
}
...
//Synthetic comment -- @@ -640,13 +640,13 @@
...
//Synthetic comment -- @@ -918,14 +918,14 @@
while (c.moveToNext()) {
...
c.close();
//Synthetic comment -- @@ -946,14 +946,14 @@
while (c.moveToNext()) {
...
c.close();
//Synthetic comment -- @@ -976,14 +976,14 @@
while (c.moveToNext()) {
...
c.close();
//Synthetic comment -- @@ -1007,14 +1007,14 @@
...
return null;
//Synthetic comment -- @@ -1436,7 +1440,7 @@
...
//Synthetic comment -- @@ -1449,15 +1453,15 @@
...
//Synthetic comment -- index 258c3b4..c92f804 100644

...
//Synthetic comment -- index 5587a42..8db4e9e 100644

//Synthetic comment -- @@ -1901,34 +1901,38 @@
...
//Synthetic comment -- @@ -1947,63 +1951,73 @@
...
s.close();
try {
//Synthetic comment -- @@ -2050,34 +2064,38 @@
* Different locale can only recognize corresponding locale sensitive
* string. ',' is used in many locales as group separator.
*/
        s = new Scanner("23,456 23,456");
...
/*
* The input string has Arabic-Indic digits.
//Synthetic comment -- @@ -2098,63 +2116,73 @@
* '.' is used in many locales as group separator. The input string
* has Arabic-Indic digits .
*/
        s = new Scanner("23.45\u0666 23.456");
...
s.close();
try {
//Synthetic comment -- @@ -3412,40 +3440,44 @@
* Different locale can only recognize corresponding locale sensitive
* string. ',' is used in many locales as group separator.
*/
        s = new Scanner("23,456 23,456");
...
/*
* The input string has Arabic-Indic digits.
//Synthetic comment -- @@ -3467,75 +3499,85 @@
* '.' is used in many locales as group separator. The input string
* has Arabic-Indic digits .
*/
        s = new Scanner("23.45\u0666 23.456");
...
/**
//Synthetic comment -- @@ -3618,40 +3660,44 @@
* Different locale can only recognize corresponding locale sensitive
* string. ',' is used in many locales as group separator.
*/
        s = new Scanner("23,456 23,456");
...
/*
* The input string has Arabic-Indic digits.
//Synthetic comment -- @@ -3674,75 +3720,85 @@
* '.' is used in many locales as group separator. The input string
* has Arabic-Indic digits .
*/
        s = new Scanner("23.45\u0666 23.456");

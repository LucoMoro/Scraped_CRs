...
//Synthetic comment -- index f31e27f..5b5a41f 100644
...
//Synthetic comment -- @@ -333,21 +338,28 @@
/**
...
//Synthetic comment -- @@ -366,12 +378,12 @@
AdbResponse resp = readAdbResponse(adbChan, false /* readDiagString */);
if (resp.okay == false) {
...
//Synthetic comment -- @@ -390,16 +402,17 @@
} else if (count == 0) {
try {
...
if (rcvr != null) {
//Synthetic comment -- @@ -424,10 +437,11 @@
...
//Synthetic comment -- @@ -439,10 +453,11 @@
...
byte[] data = new byte[16384];
//Synthetic comment -- @@ -498,12 +513,12 @@
...
if (adbChan != null) {
adbChan.close();
//Synthetic comment -- @@ -534,12 +549,12 @@
...
if (adbChan != null) {
adbChan.close();
//Synthetic comment -- @@ -703,10 +718,11 @@
...
if (device != null) {
//Synthetic comment -- @@ -716,20 +732,23 @@
...
//Synthetic comment -- index 59ae910..01814ac 100755
...
//Synthetic comment -- @@ -137,12 +141,14 @@
...
*/
//Synthetic comment -- @@ -166,12 +173,16 @@
...
//Synthetic comment -- @@ -180,55 +191,68 @@
...
//Synthetic comment -- @@ -237,38 +261,52 @@
...
//Synthetic comment -- @@ -280,57 +318,84 @@

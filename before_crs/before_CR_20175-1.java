/*Phone: Fix to send RING, CLIP and CIEV updates only after SLC establishment.

Unsolicited RING, CLIP and CIEV notifications were being sent during service
level connection establishment. Violates BT spec. Added code to disable.

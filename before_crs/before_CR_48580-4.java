...
//Synthetic comment -- index e68baca..fa11371 100644
...
//Synthetic comment -- index abe11a0..a26a9ec 100644

//Synthetic comment -- @@ -340,12 +340,12 @@
}
...
pos = 0;
beg = 0;
//Synthetic comment -- @@ -357,11 +357,15 @@
if (attType == null) {
return null;
}
while (true) {
...
switch (chars[pos]) {
//Synthetic comment -- @@ -381,11 +385,11 @@
}

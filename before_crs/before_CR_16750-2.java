...
//Synthetic comment -- index 4dfdf19..f4e9019 100644
...
lastPoint = pt;
return;
//Synthetic comment -- @@ -429,89 +503,241 @@
...
//Synthetic comment -- @@ -542,15 +768,17 @@
}
...
//Synthetic comment -- @@ -631,7 +859,13 @@
}
...
if (extent.x > width) {
//Synthetic comment -- @@ -652,8 +886,11 @@
...
//Synthetic comment -- @@ -682,6 +919,18 @@
return image;
}
...
Display.getDefault().asyncExec(new Runnable() {
public void run() {
//Synthetic comment -- @@ -746,6 +995,10 @@

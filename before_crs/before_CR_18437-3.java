...
//Synthetic comment -- index a175d49..d371f52 100644
...
//Synthetic comment -- index 55bdc06..620533b 100644
...
//Synthetic comment -- index 2fbff63..0960143 100644
...
//Synthetic comment -- @@ -633,10 +634,10 @@
* ar.exception and ar.result are null on success
*/
...
/**
*  returned message
//Synthetic comment -- @@ -1004,7 +1005,7 @@
...
/**
//Synthetic comment -- @@ -1113,7 +1114,7 @@
...
//Synthetic comment -- index 3c2b871..b3da639 100644
...
//Synthetic comment -- @@ -187,6 +192,14 @@
...
//Synthetic comment -- @@ -335,6 +351,10 @@
...
break;
//Synthetic comment -- @@ -578,5 +598,29 @@
}
}
...
//Synthetic comment -- index 83c3221..d6e1c5e 100644
...
//Synthetic comment -- @@ -112,108 +67,30 @@
}
}
...
//Synthetic comment -- @@ -236,30 +113,16 @@
*
*/
...
//Synthetic comment -- @@ -294,19 +153,7 @@
...
//Synthetic comment -- @@ -319,21 +166,7 @@
*        ((AsyncResult)onComplete.obj).exception == null on success
*        ((AsyncResult)onComplete.obj).exception != null on fail
*/
...
//Synthetic comment -- @@ -345,14 +178,7 @@
*        ((AsyncResult)onComplete.obj).exception == null on success
*        ((AsyncResult)onComplete.obj).exception != null on fail
*/
...
* When the operation is complete, onComplete will be sent to its handler
//Synthetic comment -- @@ -364,14 +190,7 @@
*        ((AsyncResult)onComplete.obj).exception == null on success
*        ((AsyncResult)onComplete.obj).exception != null on fail
*/
...
//Synthetic comment -- @@ -389,338 +208,17 @@
*         yet available
*
*/
...
//Synthetic comment -- index b12d2d4..ae9ecfe 100644
...
//Synthetic comment -- index 92ddd2c..7d44f40 100644
...
//Synthetic comment -- @@ -120,9 +125,11 @@
/**
* Default constructor
*/
...
//Synthetic comment -- index 2f22d74..873c3af 100644
...
* Licensed under the Apache License, Version 2.0 (the "License");
* you may not use this file except in compliance with the License.
//Synthetic comment -- @@ -268,7 +269,10 @@
...
//Synthetic comment -- index b73c2f7..bda8207 100644
...
//Synthetic comment -- @@ -608,16 +611,67 @@
}
...
//Synthetic comment -- @@ -632,12 +686,12 @@
...
/**
//Synthetic comment -- @@ -646,10 +700,9 @@
* @param phone PhoneBase to act on (get context from).
* @param mcc Mobile Country Code of the SIM or SIM-like entity (build prop on CDMA)
*/
...
//Synthetic comment -- index 0381bd1..6c27f78 100644
...
//Synthetic comment -- @@ -638,9 +643,10 @@
}
...
//Synthetic comment -- index 6e97a77..200253b 100644
...
@Override
//Synthetic comment -- @@ -163,6 +174,11 @@
...
//Synthetic comment -- index 1396123..335dc75 100644
...
//Synthetic comment -- @@ -689,28 +688,30 @@
}
...
//Synthetic comment -- @@ -718,28 +719,30 @@
}
...
//Synthetic comment -- @@ -747,14 +750,15 @@
}
...
//Synthetic comment -- @@ -762,14 +766,15 @@
}
...
//Synthetic comment -- @@ -853,12 +858,17 @@
}
...
send(rr);
//Synthetic comment -- @@ -1447,13 +1457,15 @@
...
//Synthetic comment -- @@ -1463,7 +1475,10 @@
...
+ " path: " + path + ","
//Synthetic comment -- @@ -1635,14 +1650,18 @@
}
...
//Synthetic comment -- @@ -1653,16 +1672,21 @@
}
...
//Synthetic comment -- @@ -2845,34 +2869,46 @@
...
//Synthetic comment -- index 6146578..c730588 100644
...
new file mode 100644
//Synthetic comment -- index 0000000..2bc5f89

//Synthetic comment -- @@ -0,0 +1,350 @@
...
new file mode 100644
//Synthetic comment -- index 0000000..108fd38

//Synthetic comment -- @@ -0,0 +1,222 @@
...
new file mode 100644
//Synthetic comment -- index 0000000..3ed785f
...
new file mode 100644
//Synthetic comment -- index 0000000..47f0bdc
...
new file mode 100644
//Synthetic comment -- index 0000000..ba6308e7
...
new file mode 100644
//Synthetic comment -- index 0000000..9301842

//Synthetic comment -- @@ -0,0 +1,229 @@
...
new file mode 100644
//Synthetic comment -- index 0000000..ff2dda9
...
//Synthetic comment -- index 1e23e34..3fd6000 100644
...
//Synthetic comment -- index a8d05552..8cee205 100644
...
//Synthetic comment -- @@ -101,9 +107,14 @@
CdmaCallTracker mCT;
...
//Synthetic comment -- @@ -151,27 +162,27 @@
...
//Synthetic comment -- @@ -234,14 +244,18 @@
...
//Synthetic comment -- @@ -250,15 +264,16 @@
...
//Synthetic comment -- @@ -540,13 +555,20 @@
...
//Synthetic comment -- @@ -724,10 +746,21 @@
...
//Synthetic comment -- @@ -783,8 +818,11 @@
}
...
//Synthetic comment -- @@ -866,14 +904,18 @@
/*package*/ void
...
//Synthetic comment -- @@ -1025,6 +1067,15 @@
}
break;
...
//Synthetic comment -- @@ -1069,7 +1120,6 @@
...
//Synthetic comment -- @@ -1088,6 +1138,7 @@
...
case EVENT_NV_READY:{
//Synthetic comment -- @@ -1123,6 +1174,44 @@
}
}
...
*/
//Synthetic comment -- @@ -1174,7 +1263,10 @@
* {@inheritDoc}
*/
...
/**
//Synthetic comment -- @@ -1479,7 +1571,7 @@
...
//Synthetic comment -- @@ -1488,4 +1580,14 @@
}
return false;
}
}
...
//Synthetic comment -- index 93e27e7..0b4a67a 100644
...
//Synthetic comment -- index f987dcd..a3c1354 100644
...
//Synthetic comment -- index 8dd8c2e..3fe28e0 100644
...
//Synthetic comment -- @@ -135,10 +138,11 @@
...
//Synthetic comment -- index cf3ead3..e0a8e791 100755
...
//Synthetic comment -- @@ -115,12 +126,6 @@
long mSavedTime;
long mSavedAtTime;
...
//Synthetic comment -- @@ -195,24 +203,32 @@
...
@Override
//Synthetic comment -- @@ -345,6 +361,10 @@
...
//Synthetic comment -- @@ -378,11 +396,6 @@
...
//Synthetic comment -- @@ -1227,6 +1243,31 @@
}
}
...
//Synthetic comment -- index 3e2a29b..441e41c 100644
...
//Synthetic comment -- index 6e12f24a..fd2d025 100644
...
//Synthetic comment -- index 6b1e9d7..0434df9 100644
...
@Override
//Synthetic comment -- @@ -142,6 +139,11 @@
...
* @param fileChanged indicates whether any files changed
//Synthetic comment -- @@ -187,14 +189,14 @@
...
if (recordsToLoad == 0 && recordsRequested == true) {
onAllRecordsLoaded();
//Synthetic comment -- @@ -299,22 +302,11 @@
...
//Synthetic comment -- @@ -375,14 +367,7 @@
break;
...
//Synthetic comment -- index 99728bd..1d5e891 100644
...
//Synthetic comment -- @@ -100,14 +106,17 @@
GsmCallTracker mCT;
...
//Synthetic comment -- @@ -141,13 +150,13 @@
...
if (!unitTestMode) {
//Synthetic comment -- @@ -155,11 +164,8 @@
...
//Synthetic comment -- @@ -221,32 +226,37 @@
mPendingMMIs.clear();
...
protected void finalize() {
//Synthetic comment -- @@ -280,12 +290,18 @@
}
...
//Synthetic comment -- @@ -866,33 +886,48 @@
}
...
//Synthetic comment -- @@ -984,11 +1019,19 @@
...
public void
//Synthetic comment -- @@ -1111,7 +1154,7 @@
// check for "default"?
boolean noData = mDataConnection.getDataEnabled() &&
getDataConnectionState() == DataState.DISCONNECTED;
...
//Synthetic comment -- @@ -1183,7 +1226,8 @@
GsmMmiCode mmi;
...
//Synthetic comment -- @@ -1267,6 +1311,10 @@
...
//Synthetic comment -- @@ -1302,9 +1350,15 @@
...
//Synthetic comment -- @@ -1338,6 +1392,21 @@
}
break;
...
//Synthetic comment -- @@ -1361,6 +1430,47 @@
}
}
...
*
//Synthetic comment -- @@ -1433,6 +1543,12 @@
}
...
//Synthetic comment -- @@ -1473,7 +1589,10 @@
* {@inheritDoc}
*/
public IccFileHandler getIccFileHandler(){
        return this.mIccFileHandler;
...
//Synthetic comment -- @@ -1491,4 +1610,18 @@
...
//Synthetic comment -- index 7dc2504..d8abea1 100644
...
//Synthetic comment -- index 5f651e7..cd5ef1c 100644
...
p.mCT.registerForVoiceCallEnded (this, EVENT_VOICE_CALL_ENDED, null);
p.mCT.registerForVoiceCallStarted (this, EVENT_VOICE_CALL_STARTED, null);
//Synthetic comment -- @@ -281,9 +288,10 @@
...
//Synthetic comment -- @@ -1254,7 +1263,12 @@
*/
...
//Synthetic comment -- @@ -1333,7 +1347,12 @@
return apnList;
}
...
//Synthetic comment -- @@ -1525,6 +1544,7 @@
}
}
...
//Synthetic comment -- index fe7a5cb..159e994 100644
...
ret.action = makeEmptyNull(m.group(MATCH_GROUP_ACTION));
ret.sc = makeEmptyNull(m.group(MATCH_GROUP_SERVICE_CODE));
//Synthetic comment -- @@ -196,11 +198,11 @@
...
//Synthetic comment -- @@ -209,10 +211,10 @@
...
//Synthetic comment -- @@ -380,12 +382,13 @@
...
//***** MmiCode implementation
//Synthetic comment -- @@ -674,10 +677,10 @@
...
throw new RuntimeException ("Invalid or Unsupported MMI Code");
//Synthetic comment -- @@ -739,24 +742,29 @@
...
//Synthetic comment -- @@ -860,7 +868,11 @@
*/
...
onSetComplete(ar);
//Synthetic comment -- @@ -1178,7 +1190,11 @@
...
//Synthetic comment -- @@ -1203,7 +1219,11 @@
...
//Synthetic comment -- index 1dc46d7..b018505 100644
...
//Synthetic comment -- @@ -123,12 +133,6 @@
long mSavedTime;
long mSavedAtTime;
...
//Synthetic comment -- @@ -234,13 +239,24 @@
...
protected void finalize() {
//Synthetic comment -- @@ -355,19 +371,19 @@
...
pollState();
//Synthetic comment -- @@ -586,8 +602,12 @@
}
...
//Synthetic comment -- @@ -1053,6 +1073,41 @@
...
* Returns a TimeZone object based only on parameters from the NITZ string.
*/
//Synthetic comment -- @@ -1166,7 +1221,7 @@
...
//Synthetic comment -- index e8d10f9..4827e54 100644
...
//Synthetic comment -- index 7db21c0..4a522d6 100644
...
//Synthetic comment -- @@ -146,10 +149,10 @@
...
//Synthetic comment -- @@ -160,11 +163,10 @@
recordsToLoad = 0;
...
//Synthetic comment -- @@ -298,14 +299,14 @@
...
Log.w(LOG_TAG,
//Synthetic comment -- @@ -451,14 +452,14 @@
...
// ***** Overridden from Handler
//Synthetic comment -- @@ -470,14 +471,14 @@
...
//Synthetic comment -- @@ -496,22 +497,22 @@
break;
}
...
mncLength = UNKNOWN;
//Synthetic comment -- @@ -521,10 +522,9 @@
...
//Synthetic comment -- @@ -555,13 +555,13 @@
...
//Synthetic comment -- @@ -775,10 +775,10 @@
...
//Synthetic comment -- @@ -1039,20 +1039,20 @@
...
break;
default:
//Synthetic comment -- @@ -1086,7 +1086,7 @@
break;
case CommandsInterface.SIM_REFRESH_RESET:
...
//Synthetic comment -- @@ -1151,7 +1151,7 @@
ba[0] = 1;
...
//Synthetic comment -- @@ -1162,6 +1162,7 @@
// One record loaded successfully or failed, In either case
// we need to update the recordsToLoad count
recordsToLoad -= 1;
...
if (recordsToLoad == 0 && recordsRequested == true) {
onAllRecordsLoaded();
//Synthetic comment -- @@ -1177,12 +1178,11 @@
...
//Synthetic comment -- @@ -1193,8 +1193,6 @@
...
//***** Private methods
//Synthetic comment -- @@ -1215,42 +1213,36 @@
}
...
//Synthetic comment -- @@ -1258,39 +1250,39 @@
...
//Synthetic comment -- @@ -1303,7 +1295,7 @@
...
//Synthetic comment -- @@ -1390,7 +1382,7 @@
case INIT:
spn = null;
...
//Synthetic comment -- @@ -1404,11 +1396,11 @@
...
//Synthetic comment -- @@ -1426,12 +1418,12 @@
...
//Synthetic comment -- @@ -1444,7 +1436,7 @@
data, 0, data.length - 1);
...
//Synthetic comment -- @@ -1550,7 +1542,6 @@
...
//Synthetic comment -- index feb508a..8216d2d 100644
...
//Synthetic comment -- index b642541..fccb4f8 100644
...
//Synthetic comment -- index e9014ff..68f1996 100644

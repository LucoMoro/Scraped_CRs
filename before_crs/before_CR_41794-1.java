...
In some cases some user reported they see a line in
the sdk manage log that just says "null". Turns out
it's an NPE when trying to read the null InputStream
returned by UrlOpener in case of a fail URL fetch.

UrlOpener used to return an IOException when a resource

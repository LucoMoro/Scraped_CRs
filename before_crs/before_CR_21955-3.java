...
old mode 100644
new mode 100755
//Synthetic comment -- index bca091f..c46aefb
...
//Synthetic comment -- @@ -653,12 +655,15 @@
*/
...
old mode 100644
new mode 100755
//Synthetic comment -- index 5587a42..c18cb5d
...
//Synthetic comment -- @@ -1947,18 +1953,21 @@
...
//Synthetic comment -- @@ -1984,26 +1993,33 @@
...
/*
* The input string has Arabic-Indic digits.
//Synthetic comment -- @@ -2098,18 +2120,21 @@
* '.' is used in many locales as group separator. The input string
* has Arabic-Indic digits .
*/
        s = new Scanner("23.45\u0666 23.456");
...
// The input string starts with zero
s = new Scanner("03,456");
//Synthetic comment -- @@ -2136,25 +2161,28 @@
* There are 3 types of zero digit in all locales, '0' '\u0966' '\u0e50'
* respectively, but they are not differentiated.
*/
        s = new Scanner("12300");
...
s.close();
try {
//Synthetic comment -- @@ -3412,40 +3440,46 @@
* Different locale can only recognize corresponding locale sensitive
* string. ',' is used in many locales as group separator.
*/
        s = new Scanner("23,456 23,456");
...
/*
* The input string has Arabic-Indic digits.
//Synthetic comment -- @@ -3467,21 +3501,24 @@
* '.' is used in many locales as group separator. The input string
* has Arabic-Indic digits .
*/
        s = new Scanner("23.45\u0666 23.456");
...
// The input string starts with zero
s = new Scanner("03,456");
//Synthetic comment -- @@ -3511,31 +3548,38 @@
* There are 3 types of zero digit in all locales, '0' '\u0966' '\u0e50'
* respectively, but they are not differentiated.
*/
        s = new Scanner("12300");
...
/**
//Synthetic comment -- @@ -3618,40 +3662,46 @@
* Different locale can only recognize corresponding locale sensitive
* string. ',' is used in many locales as group separator.
*/
        s = new Scanner("23,456 23,456");
...
/*
* The input string has Arabic-Indic digits.
//Synthetic comment -- @@ -3674,21 +3724,25 @@
* '.' is used in many locales as group separator. The input string
* has Arabic-Indic digits .
*/
        s = new Scanner("23.45\u0666 23.456");
...
// The input string starts with zero
s = new Scanner("03,456");
//Synthetic comment -- @@ -3719,30 +3773,37 @@
* There are 3 types of zero digit in all locales, '0' '\u0966' '\u0e50'
* respectively, but they are not differentiated.
*/
        s = new Scanner("12300");

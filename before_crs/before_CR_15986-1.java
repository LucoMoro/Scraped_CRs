...
//Synthetic comment -- index 91cbe2f..a55b2de 100644

//Synthetic comment -- @@ -16,32 +16,29 @@
...
//Synthetic comment -- @@ -119,8 +116,14 @@
...
//Synthetic comment -- @@ -133,8 +136,14 @@
*
* @param pkgName Android application package for tests
...
//Synthetic comment -- @@ -142,22 +151,26 @@
/**
...
//Synthetic comment -- @@ -167,10 +180,11 @@
* @param localFilePath the absolute file system path to file on local host to install
* @param reinstall set to <code>true</code> if re-install of app should be performed
...
return result;
//Synthetic comment -- @@ -180,10 +194,17 @@
...
//Synthetic comment -- @@ -198,9 +219,14 @@
*
...
//Synthetic comment -- @@ -211,10 +237,15 @@
...
//Synthetic comment -- @@ -224,9 +255,14 @@
*
...
//Synthetic comment -- @@ -236,9 +272,14 @@
*
...
//Synthetic comment -- @@ -247,9 +288,14 @@
*
* @param packageName package name to check for
* @return <code>true</code> if file exists, <code>false</code> otherwise.
     * @throws IOException if adb shell command failed
...
//Synthetic comment -- @@ -258,9 +304,14 @@
*
* @param packageName package name to check for
* @return <code>true</code> if file exists, <code>false</code> otherwise.
     * @throws IOException if adb shell command failed
...
//Synthetic comment -- @@ -268,9 +319,14 @@
...
//Synthetic comment -- @@ -336,9 +392,14 @@
*
...
//Synthetic comment -- @@ -355,9 +416,14 @@
/**
...
//Synthetic comment -- @@ -369,9 +435,14 @@
/**
...
//Synthetic comment -- @@ -389,10 +460,15 @@
/**
...
CollectingOutputReceiver receiver = new CollectingOutputReceiver();
//Synthetic comment -- @@ -545,17 +621,23 @@
/**
...
//Synthetic comment -- @@ -576,17 +658,23 @@
/**
* Helper method for installing an app to wherever is specified in its manifest, and
...
if (!overwrite) {
// cleanup test app just in case it already exists
//Synthetic comment -- @@ -607,17 +695,24 @@
/**
...
if (!overwrite) {
// cleanup test app just in case it already exists
//Synthetic comment -- @@ -638,14 +733,21 @@
...
//Synthetic comment -- @@ -655,12 +757,18 @@
...
//Synthetic comment -- @@ -685,8 +793,14 @@
*
* <p/>
* Assumes adb is running as root in device under test.
*/
...
int locValue = 0;
switch (pref) {
//Synthetic comment -- @@ -708,8 +822,14 @@
*
* <p/>
* Assumes adb is running as root in device under test.
*/

...
mRouteList member in VpnProfile contains comma-separated list of subnets to be accessed through VPN in form of address/mask. mExcludeRouteList - contains
comma-separated list of subnets excluded from VPN in a format of "address/mask,address/mask". If mRouteList and mExcludeRouteList are empty, then all traffic gets redirected to VPN (default behaviour).
...
//Synthetic comment -- index 499195f..e159b47 100644

//Synthetic comment -- @@ -46,15 +46,15 @@
...
//Synthetic comment -- @@ -117,12 +117,12 @@
...
//Synthetic comment -- @@ -143,5 +143,13 @@
if (encryption) {
args.add("+mppe");
}
}

...
//Synthetic comment -- index d7f2e3c..6c70f76 100644
...
//Synthetic comment -- index 5fb1132..1337816 100644

//Synthetic comment -- @@ -980,16 +980,20 @@
...
//Synthetic comment -- index f3da39c..866d5b6 100644
...
//Synthetic comment -- @@ -121,6 +133,25 @@
return mName;
}
...
//Synthetic comment -- index 6aeeade..62720e7 100644
...
//Synthetic comment -- @@ -112,6 +116,36 @@
SdkConstants.FN_DX);
...
//Synthetic comment -- index 37265b1..b9728a8 100644
...
//Synthetic comment -- index 3e6e23e..501b9a3 100644

//Synthetic comment -- @@ -355,15 +355,17 @@
return null;
}
...
//Synthetic comment -- @@ -380,6 +382,30 @@
return null;
}
...
//Synthetic comment -- index 2471500..a3dcf35 100644
...
//Synthetic comment -- @@ -217,11 +225,12 @@
...
/**
//Synthetic comment -- @@ -234,15 +243,17 @@
* @param path The path to the config.ini file
* @param targetHash the target hash
* @param target The target. Can be null, if the target was not resolved.
         * @param abiType Name of the abi.
...
//Synthetic comment -- @@ -257,6 +268,45 @@
return mPath;
}
...
*/
//Synthetic comment -- @@ -588,14 +638,17 @@
/**
...
//Synthetic comment -- @@ -649,17 +703,20 @@
...
//Synthetic comment -- @@ -667,12 +724,20 @@
...
//Synthetic comment -- @@ -942,9 +1013,9 @@
...
//Synthetic comment -- @@ -1166,7 +1237,7 @@
...
// update the ini file
//Synthetic comment -- @@ -1186,7 +1257,7 @@
...
//Synthetic comment -- @@ -1329,6 +1400,14 @@
...
if (properties != null) {
//Synthetic comment -- @@ -1374,6 +1453,7 @@
avdPath,
targetHash,
target,
                abiType,
...
//Synthetic comment -- @@ -1585,7 +1665,7 @@
AvdStatus status;
...
//Synthetic comment -- @@ -1617,6 +1697,7 @@
avd.getPath(),
avd.getTargetHash(),
avd.getTarget(),
                avd.getAbiType(),
...
//Synthetic comment -- @@ -1626,13 +1707,14 @@
/**
...
//Synthetic comment -- @@ -1640,7 +1722,7 @@
...
//Synthetic comment -- @@ -1650,7 +1732,7 @@
...
//Synthetic comment -- index 53a6c76..2b713ec 100644
...
//Synthetic comment -- @@ -286,10 +289,29 @@
...
//Synthetic comment -- @@ -670,6 +692,21 @@
for (int i = 0;i < n; i++) {
...
//Synthetic comment -- @@ -884,6 +922,49 @@
}
...
*/
//Synthetic comment -- @@ -907,6 +988,16 @@
...
//Synthetic comment -- @@ -1122,6 +1213,19 @@
return false;
}
...
//Synthetic comment -- @@ -1190,6 +1294,7 @@
avdFolder,
avdName,
target,
                mAbiType,

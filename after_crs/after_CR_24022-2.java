...
//Synthetic comment -- index 4110e8d..e0c26ed 100644
...
//Synthetic comment -- @@ -278,6 +277,18 @@
...
if (generateRClass) {
            ...
            for (Path p : mResources) {
                watchPaths.add(new File(p.toString()));
            }
...
new file mode 100644
//Synthetic comment -- index 0000000..ebbd194
...
public class DependencyGraph {
    ...
    public boolean dependenciesHaveChanged() {
        ...
        return mTargets.size() == 0 || missingPrereqFile() ||

...
- AT&T network doesn't support SMS delivery reports, so don't wait to receive
   ...
   to SmsManagerTest.java if we know that they ignore TP-Status-Report-Request.
- Remove unnecessary cast in cts/SmsMessageTest.java.
- Add @Override annotation in gsm/cts/SmsManagerTest.java.
- Device emulator doesn't support SMS delivery reports.
...
//Synthetic comment -- index 3f75f94..a8ab738 100644
...
mText = "This is a test message";
        ...
        if (mTelephonyManager.getPhoneType() == TelephonyManager.PHONE_TYPE_CDMA) {
            ...
            // AT&T network doesn't support SMS delivery report
            String mccmnc = mTelephonyManager.getSimOperator();
            mDeliveryReportSupported = (!mccmnc.equals("310410"));
        }
}

@TestTargetNew(
//Synthetic comment -- @@ -120,8 +133,10 @@
...
//Synthetic comment -- @@ -134,8 +149,10 @@
...
init();
//Synthetic comment -- @@ -148,8 +165,10 @@
...
private void init() {
//Synthetic comment -- @@ -220,12 +239,20 @@
}
}

...
//Synthetic comment -- index 18c4fe6..ff0579c 100644
...
//Synthetic comment -- @@ -456,6 +458,12 @@
}
...
if (xDiff > mTouchSlop) {
//Synthetic comment -- @@ -557,6 +565,11 @@
}
...
//Synthetic comment -- index ebc54f4..8747dc3 100644
...
//Synthetic comment -- @@ -478,6 +481,12 @@
}
...
if (yDiff > mTouchSlop) {
//Synthetic comment -- @@ -585,6 +594,11 @@
}
case MotionEvent.ACTION_MOVE:
final int activePointerIndex = ev.findPointerIndex(mActivePointerId);
                if (activePointerIndex == -1) {

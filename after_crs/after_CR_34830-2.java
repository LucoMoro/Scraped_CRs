...
//Synthetic comment -- index 4539c6b..af92602 100644
...
mScanIntent = PendingIntent.getBroadcast(mContext, SCAN_REQUEST, scanIntent, 0);
        ...
        mDriverStopIntent = PendingIntent.getBroadcast(mContext, DRIVER_STOP_REQUEST, driverStopIntent, 0);
...
//Synthetic comment -- @@ -2600,14 +2618,15 @@
sendMessage(obtainMessage(CMD_DELAYED_STOP_DRIVER, mDelayedStopCounter, 0));
} else {

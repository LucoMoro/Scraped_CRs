...
//Synthetic comment -- index 1a2e787..6f230f4 100644
...
//Synthetic comment -- @@ -294,6 +299,11 @@
...
//Synthetic comment -- @@ -1011,6 +1023,7 @@
...
//Synthetic comment -- @@ -1022,6 +1035,7 @@
...
if (mSelectedEvent == null) {
mLastPopupEventID = INVALID_EVENT_ID;
//Synthetic comment -- @@ -1033,6 +1047,7 @@
...
if (mSelectedEvent == null) {
mLastPopupEventID = INVALID_EVENT_ID;
//Synthetic comment -- @@ -1049,6 +1064,7 @@
...
if (mSelectedEvent == null) {
mLastPopupEventID = INVALID_EVENT_ID;
//Synthetic comment -- @@ -1107,11 +1123,13 @@
...
//Synthetic comment -- @@ -1213,6 +1231,8 @@
mPrevSelectedEvent = null;
mSelectedEvents.clear();
...
//Synthetic comment -- @@ -1233,6 +1253,11 @@
...
mRedrawScreen = true;
mComputeSelectedEvents = true;
//Synthetic comment -- @@ -1681,6 +1706,45 @@
return box;
}
...
//Synthetic comment -- @@ -1755,7 +1819,8 @@
...
//Synthetic comment -- @@ -1772,7 +1837,8 @@
if (mSelectedEvent != null) {
...
//Synthetic comment -- @@ -1852,6 +1918,7 @@
} else {
...
//Synthetic comment -- @@ -1907,7 +1974,8 @@
}
...
//Synthetic comment -- @@ -1915,7 +1983,8 @@
computeNeighbors();
if (mSelectedEvent != null) {
...
//Synthetic comment -- @@ -2205,6 +2274,7 @@
...
//Synthetic comment -- @@ -2285,7 +2355,7 @@
return string;
}
...
//Synthetic comment -- @@ -2301,78 +2371,15 @@
return;
}
...
//Synthetic comment -- @@ -2965,6 +2972,7 @@
...
mSelectedEvents.clear();
if (mSelectionAllDay) {
//Synthetic comment -- @@ -3052,6 +3060,7 @@
}
}

/*fix the wrong title template display when switch phone in add title view

Root cause:
when switch the phone, the overlay type is not saved by the app, so after
rotation, the default overlay type will be used to display the title template.

Change-Id:If1acac6c978d0e7f4358c64565ab7e4164f8f0d7Author: Wangyi Gu <wangyi.gu@intel.com>

...
//Synthetic comment -- index 2cc3b02..aa8758d 100644

//Synthetic comment -- @@ -949,7 +949,13 @@
final ComponentName appName = getAssociatedActivity();
if (appName != null && searchManager.getSearchableInfo(appName) != null) {
searchManager.startSearch(null, false, appName, null, false);
            if (mCancelable) {
                //here should cancel the dialog, if not, if it is an alertdialog,
                //it will block thread always.
                cancel();
            } else {
                dismiss();
            }

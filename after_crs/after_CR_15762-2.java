...
//Synthetic comment -- index 7b39076..1c8143c 100644
...
return adbChan;
//Synthetic comment -- @@ -112,9 +112,11 @@
* @param device the device to connect to. Can be null in which case the connection will be
* to the first available device.
...
SocketChannel adbChan = SocketChannel.open(adbSockAddr);
try {
//Synthetic comment -- @@ -128,17 +130,20 @@
...
return adbChan;
//Synthetic comment -- @@ -196,17 +201,16 @@
...
if (isOkay(reply)) {
resp.okay = true;
//Synthetic comment -- @@ -216,38 +220,37 @@
}
...
return resp;
//Synthetic comment -- @@ -255,9 +258,11 @@
...
//Synthetic comment -- @@ -275,25 +280,17 @@
...
//Synthetic comment -- @@ -304,12 +301,8 @@
...
//Synthetic comment -- @@ -323,15 +316,10 @@
...
//Synthetic comment -- @@ -344,12 +332,20 @@
}
...
//Synthetic comment -- @@ -363,17 +359,17 @@
setDevice(adbChan, device);
...
//Synthetic comment -- @@ -391,10 +387,19 @@
break;
} else if (count == 0) {
try {
...
//Synthetic comment -- @@ -412,26 +417,30 @@
/**
...
try {
//Synthetic comment -- @@ -443,12 +452,10 @@
setDevice(adbChan, device);
...
//Synthetic comment -- @@ -490,10 +497,11 @@
...
SocketChannel adbChan = null;
try {
//Synthetic comment -- @@ -504,21 +512,18 @@
...
/**
//Synthetic comment -- @@ -528,10 +533,11 @@
...
SocketChannel adbChan = null;
try {
//Synthetic comment -- @@ -542,21 +548,18 @@
...
/**
//Synthetic comment -- @@ -584,22 +587,16 @@
/**
...
// non-blocking spin
try {
//Synthetic comment -- @@ -646,20 +643,15 @@
}
...
/**
//Synthetic comment -- @@ -670,10 +662,11 @@
* @param data the buffer to send.
...
// non-blocking spin
try {
//Synthetic comment -- @@ -707,19 +700,18 @@
*
...
//Synthetic comment -- index bd6f436..18be286 100755
...
//Synthetic comment -- @@ -181,33 +182,59 @@
...
public void executeShellCommand(String command,
     ...
     * @param timeout the timeout. If 0, there is no timeout.
     * @throws TimeoutException in case of timeout on the connection.
     * @throws IOException in case of I/O error on the connection.
     */
    public void executeShellCommand(String command,
...
//Synthetic comment -- @@ -238,42 +265,48 @@

...
//Synthetic comment -- index 3932653..fa6d077 100644

//Synthetic comment -- @@ -19,28 +19,35 @@
public class CategoryTest extends AbstractMonkeyTest {

public void testDefaultCategories() throws Exception {
        String out = mDevice.executeShellCommand("monkey -v -v -p " + PKGS[0] + " 5000");
...
public void testSingleCategory() throws Exception {
        String out = mDevice.executeShellCommand("monkey -v -v -p " + PKGS[0]
+ " -c android.intent.category.LAUNCHER 5000");
	System.out.println("single launcher out = " + out);
        ...
        out = mDevice.executeShellCommand("monkey -v -v -p " + PKGS[0]
...
public void testSinglePackage() throws Exception {
        ...
        out = mDevice.executeShellCommand("monkey -v -v -p " + PKGS[1] + " 5000");
        assertFalse(out.contains("component=com.android.cts.monkey/.MonkeyActivity"));

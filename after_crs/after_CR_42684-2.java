...
//Synthetic comment -- index 58ddaf3..cbb2fc2 100644

//Synthetic comment -- @@ -509,7 +509,9 @@
try {
Thread.sleep(ms);
} catch (InterruptedException e) {
            // If it's stopped early, do NOT acquire wakelock to avoid
            // high power consumption in flight mode or some cases else.
            runAsleep = false;
} finally {
if (runAsleep) {

...
//Synthetic comment -- index 1af04a8..addfe78 100644
...
//Synthetic comment -- @@ -198,13 +199,21 @@
*/
@Override
...
AndroidXmlEditor editor = uiNode.getEditor();
        String namePrefix = UiElementNode.lookupNamespacePrefix(uiNode.getXmlNode(), ANDROID_URI);
        if (namePrefix == null) {
            namePrefix = ANDROID_NS_NAME_PREFIX;
        } else {
            namePrefix = namePrefix + ':';
        }

        if (prefix == null || !prefix.contains(namePrefix)) {
IProject project = editor.getProject();
if (project != null) {
// get the resource repository for this project and the system resources.
//Synthetic comment -- @@ -242,12 +251,23 @@
// resource types.

...
//Synthetic comment -- index e44b0b3..2b4c279 100755
...
//Synthetic comment -- @@ -546,10 +547,10 @@
...
//Synthetic comment -- @@ -685,11 +686,22 @@
BufferedImage image = result.getImage();
if (image != null) {
BufferedImage cropped;
                    Rect initialCrop = null;
                    ViewInfo rootView = result.getRootView();
                    if (rootView != null) {
                        ViewInfo viewInfo = rootView;

...
//Synthetic comment -- index 0000000..cce0b96
...
//Synthetic comment -- index f31e27f..a1932e7 100644

//Synthetic comment -- @@ -68,9 +68,10 @@
...
//Synthetic comment -- @@ -112,10 +113,12 @@
...
adbChan.configureBlocking(true);
//Synthetic comment -- @@ -258,10 +261,11 @@
/**
...
//Synthetic comment -- @@ -338,16 +342,22 @@
...
//Synthetic comment -- @@ -366,12 +376,12 @@
AdbResponse resp = readAdbResponse(adbChan, false /* readDiagString */);
if (resp.okay == false) {
...
//Synthetic comment -- @@ -390,16 +400,16 @@
} else if (count == 0) {
try {
...
if (rcvr != null) {
//Synthetic comment -- @@ -424,10 +434,11 @@
...
//Synthetic comment -- @@ -439,10 +450,11 @@
...
byte[] data = new byte[16384];
//Synthetic comment -- @@ -498,12 +510,12 @@
...
if (adbChan != null) {
adbChan.close();
//Synthetic comment -- @@ -534,12 +546,12 @@
...
if (adbChan != null) {
adbChan.close();
//Synthetic comment -- @@ -703,10 +715,11 @@
...
if (device != null) {
//Synthetic comment -- @@ -716,20 +729,22 @@
...
//Synthetic comment -- index 24c20b2..983aab1 100644
...
//Synthetic comment -- index 59ae910..96df4d9 100755
...
//Synthetic comment -- @@ -183,52 +184,64 @@
...
//Synthetic comment -- @@ -237,9 +250,11 @@
...
//Synthetic comment -- @@ -249,26 +264,35 @@
* @throws TimeoutException in case of timeout on the connection. This can only be thrown if the
* timeout happens during setup. Once logs start being received, no timeout will occur as it's
* not possible to detect a difference between no log and timeout.
     * @throws AdbCommandRejectedException if adb rejects the command
...
//Synthetic comment -- @@ -284,53 +308,75 @@
...
new file mode 100644
//Synthetic comment -- index 0000000..b4a900e
 ...
 * <p/>The command may not actually be unresponsive, it just has taken too long to send its
 * output.
 */

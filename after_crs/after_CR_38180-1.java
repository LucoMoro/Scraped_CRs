...
uimodes.add(d);
                        ...
                        // Device uses "tv", UiMode uses "television"
                        uimodes.add(UiMode.TELEVISION);
}
}
...
mState.mDescription = getString(mStringAccumulator);
                ...
                String orientation = getString(mStringAccumulator);
                for(ScreenOrientation orientationEnum : ScreenOrientation.values())
                if (orientation.startsWith(orientationEnum.getResourceValue())){
                    mState.mOrientation = orientationEnum;
                    break;
                }

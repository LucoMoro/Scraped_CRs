...
//Synthetic comment -- index 7f70859..769ca1e 100644
...
//Synthetic comment -- index 6ee74ed..930e8de 100644
...
//Synthetic comment -- @@ -1187,7 +1188,10 @@
...
//Synthetic comment -- @@ -1661,4 +1665,3 @@
}
}
}
...
//Synthetic comment -- index 1fe6d97..1e0b6ce 100644

//Synthetic comment -- @@ -981,16 +981,20 @@
...
//Synthetic comment -- index f3da39c..f310eea 100644
...
*/
    AddOnTarget(String[] abis, String location, String name, String vendor, int revision,
            String description, Map<String, String[]> libMap, PlatformTarget basePlatform) {
if (location.endsWith(File.separator) == false) {
location = location + File.separator;
}
//Synthetic comment -- @@ -99,6 +102,14 @@
...
//Synthetic comment -- @@ -121,6 +132,25 @@
return mName;
}
    ...
    */
    public String getImagePath(String abiType) {
        ...
        // Use legacy directory structure if only arm
            return mLocation + SdkConstants.OS_IMAGES_FOLDER; //$NON-NLS-1$
        } else {
...
//Synthetic comment -- index c0dcaa7..2ca7763 100644
...
//Synthetic comment -- @@ -227,6 +225,16 @@
int getUsbVendorId();
...
//Synthetic comment -- index 6aeeade..c86ef8f 100644
...
@SuppressWarnings("deprecation")
    PlatformTarget(String[] abis, String sdkOsPath, String platformOSPath,
...
//Synthetic comment -- @@ -112,6 +115,36 @@
SdkConstants.FN_DX);
...
SdkConstants.FN_DX_JAR);
    ...
    public String getImagePath(String abiType) {
        if (mAbiCompatibilityMode) {
            ...
            return mRootFolderOsPath + SdkConstants.OS_IMAGES_FOLDER + abiType + File.separator; //following review
        }
    }
...
//Synthetic comment -- index f8f7f19..b9728a8 100644
...
//Synthetic comment -- index 767e582..04a1024 100644

//Synthetic comment -- @@ -351,8 +351,10 @@
return null;
}
...
map,
//Synthetic comment -- @@ -376,7 +378,31 @@
return null;
}
...
//Synthetic comment -- @@ -510,7 +536,8 @@
}
}

            String[] abiList = getAbiList(addonDir.getAbsolutePath());
            AddOnTarget target = new AddOnTarget(abiList, addonDir.getAbsolutePath(), name, vendor,
...
//Synthetic comment -- index eba8e07..8c952cc 100644
...
//Synthetic comment -- @@ -228,6 +239,45 @@
return mPath;
}
...
*/
//Synthetic comment -- @@ -497,14 +547,17 @@
/**
...
//Synthetic comment -- @@ -558,17 +612,20 @@
...
//Synthetic comment -- @@ -576,12 +633,20 @@
...
//Synthetic comment -- @@ -1070,7 +1141,7 @@
...
// update the ini file
//Synthetic comment -- @@ -1090,7 +1161,7 @@
...
//Synthetic comment -- @@ -1233,6 +1304,14 @@
...
if (properties != null) {
//Synthetic comment -- @@ -1278,6 +1357,7 @@
avdPath,
targetHash,
target,
                abiType,
...
//Synthetic comment -- @@ -1489,7 +1569,7 @@
AvdStatus status;
...
//Synthetic comment -- @@ -1521,6 +1601,7 @@
avd.getPath(),
avd.getTargetHash(),
avd.getTarget(),
                avd.getAbiType(),
...
//Synthetic comment -- @@ -1530,13 +1611,14 @@
/**
...
//Synthetic comment -- @@ -1544,7 +1626,7 @@
...
//Synthetic comment -- @@ -1554,7 +1636,7 @@
...
//Synthetic comment -- index 4411034..52f7d01 100644
...
validatePage();
        ...
        label.setText("Abi Type:");
        tooltip = "The Abi Type to use in the virtual device";
...
//Synthetic comment -- @@ -882,6 +920,49 @@
}
...
*/
//Synthetic comment -- @@ -905,6 +986,16 @@
...
//Synthetic comment -- @@ -1102,6 +1193,19 @@
return false;
}
...
//Synthetic comment -- @@ -1169,6 +1273,7 @@
avdFolder,
avdName,
target,
                mAbiType,
...
//Synthetic comment -- index 409c25d..9ba2387 100644
...
//Synthetic comment -- index 5e26a41..e5e350b 100644
...
//Synthetic comment -- @@ -1025,10 +1031,7 @@

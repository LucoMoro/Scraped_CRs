...
//Synthetic comment -- index 781deaf..d2b0d82 100644

//Synthetic comment -- @@ -738,6 +738,8 @@
public boolean accept(AvdInfo avd) {
if (mDevices != null) {
for (IDevice d : mDevices) {
                    System.out.println("target api level = " + avd.getTarget().getVersion().getApiLevel());
                    System.out.println("project target: " + mProjectTarget.getVersion().getApiLevel());

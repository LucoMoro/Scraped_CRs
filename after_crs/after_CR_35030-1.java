...
public static final int HEIGHT = 240;
    public static final int WIDTH_SMALL = 160;
    public static final int HEIGHT_SMALL = 120;
    public static final int THRESHOLD_HEIGHT = 720;
...
setContentView(R.layout.mediaplayer);
        ...
        // For low resolution screens: make video small enough to fit ~3 times
        // in the screen. Disregard the top window decoration.
        int width, height;
        Point point = new Point();
        getWindowManager().getDefaultDisplay().getSize(point);

        if (point.y < THRESHOLD_HEIGHT) {
            width = WIDTH_SMALL;
            height = HEIGHT_SMALL;
        } else {
            width = WIDTH;

...
1. Fix ArrayIndexOutOfBoundsException when scrolling Mms appwidget due to
the type count is not correct.
2. Need to use PendingIntent instead to set the click listener for "View
more conversations"
3. No need to lock sWidgetLock in getConversationCount(), since it was already
locked outside.
...
//Synthetic comment -- index bb01772..a0644a8 100644

/*Fixed media sets still appearing issue after all albums in Gallery3D are deleted
...
//Synthetic comment -- index c8a5fc0..45a171e 100644

//Synthetic comment -- @@ -1011,26 +1011,34 @@
}
++ctr;
} while (ctr < numSets);
                }
                        ...
                        for (int i = 0; i < numAlbums; ++i) {
                            ...
                            if (!setIds.contains(setId)) {
                                final byte[] existingData
                                        = sAlbumCache.get(ALBUM_CACHE_DIRTY_INDEX, 0);

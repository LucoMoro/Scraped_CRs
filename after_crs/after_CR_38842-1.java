...
Gallery2 -> open photo -> doodle it -> save -> doodle again -> repeat this action sometimes -> go back to see the old doodles.
Above actions may cause outofmemory exception for there will be duplicated origin photos in the momery, i recycle the duplicated photos that solve this memory leak.
...
//Synthetic comment -- index 277e06d..e255dd3 100644

...
One pinyin initial may match many contacts. E.g. looking up BT can get Bai Tao, Bai Ting, Bi Teng, Bao Tou and etc. So use all characters of the last token to narrow the lookup results. That means BTao for Bai Tao, BTing for Bai Ting, BTeng for Bi Teng and so on.
...
//Synthetic comment -- index 1c2ad97..e4d2826 100644
...
keyOrignal.insert(0, ' ');
                ...
                if (tokenString != null) {
                    ...
                    // E.g. lookup BT can get Bai Tao, Bai Ting, Bi Teng, Bao Tou and etc.

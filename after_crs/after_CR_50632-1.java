...
checkValidErrorType(DrmErrorEvent.TYPE_ACQUIRE_DRM_INFO_FAILED);
        checkValidErrorType(DrmErrorEvent.TYPE_VENDOR_SPECIFIC_ERROR);
}
...
checkValidInfoType(DrmInfoEvent.TYPE_RIGHTS_REMOVED);
        checkValidInfoType(DrmInfoEvent.TYPE_VENDOR_SPECIFIC);
...
checkInfoTypeInErrorEvent(DrmInfoEvent.TYPE_RIGHTS_REMOVED);
        checkInfoTypeInErrorEvent(DrmInfoEvent.TYPE_VENDOR_SPECIFIC);
...
checkErrorTypeInInfoEvent(DrmErrorEvent.TYPE_ACQUIRE_DRM_INFO_FAILED);
        checkErrorTypeInInfoEvent(DrmErrorEvent.TYPE_VENDOR_SPECIFIC_ERROR);
}
...
checkInvalidInfoType(
                DrmInfoRequest.TYPE_VENDOR_SPECIFIC_INFO + 1);
}
...
DrmInfoRequest.TYPE_RIGHTS_ACQUISITION_PROGRESS_INFO);
        checkValidInfoType(DrmInfoRequest.TYPE_VENDOR_SPECIFIC_INFO);
}
...
checkGetInfoType(
DrmInfoRequest.TYPE_RIGHTS_ACQUISITION_PROGRESS_INFO);
        checkGetInfoType(DrmInfoRequest.TYPE_VENDOR_SPECIFIC_INFO);
}

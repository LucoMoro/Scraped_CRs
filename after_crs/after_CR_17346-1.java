...
//Synthetic comment -- index 180af4c..e3b0461 100644
...
//Synthetic comment -- @@ -312,7 +315,13 @@
}
...
//Synthetic comment -- @@ -910,6 +919,13 @@
...
//Synthetic comment -- @@ -1581,4 +1597,8 @@
}
return null;
}
...
//Synthetic comment -- index 751bc4f..69451a1 100644
...
//Synthetic comment -- index af3d46f..12d2aec 100644
...
private CommonAction mExportAction;
    private CommonAction gotoMethodDeclarationAction;
    private CommonAction gotoErrorLineAction;

private CommonAction[] mLogLevelActions;
private String[] mLogLevelIcons = {
//Synthetic comment -- @@ -151,6 +157,48 @@
}
}
    ...
    private class LogCatViewSearchRequestor extends SearchRequestor {
        ...
        private boolean found_first_match = false;
        ...
        public void acceptSearchMatch(SearchMatch match) throws CoreException {
            if (match.getResource() instanceof IFile
                ...
                .getResource();
                IMarker marker = null;
                if (CHOICE_ERROR_LINE.equals(mChoice)) {    
                    marker = matched_file.createMarker(IMarker.TEXT);
                    marker.setAttribute(IMarker.LINE_NUMBER, mLineNumber);
                } else if (CHOICE_METHOD_DECLARATION.equals(mChoice)) {
                    marker = createMarkerFromSearchMatch(
                            matched_file, match);
...
//Synthetic comment -- @@ -226,10 +274,17 @@
...
mExportAction.setImageDescriptor(loader.loadDescriptor("save.png")); // $NON-NLS-1$
        ...
        gotoMethodDeclarationAction = new CommonAction("Go to Problem (method declaration)") {
@Override
public void run() {
        ...
        gotoErrorLineAction = new CommonAction("Go to Problem (error line)") {
            @Override
            public void run() {
...
// get the font
//Synthetic comment -- @@ -335,7 +391,8 @@
menuManager.add(mClearAction);
menuManager.add(new Separator());
menuManager.add(mExportAction);
        menuManager.add(gotoMethodDeclarationAction);
        menuManager.add(gotoErrorLineAction);

// and then in the toolbar
IToolBarManager toolBarManager = actionBars.getToolBarManager();
//Synthetic comment -- @@ -396,57 +453,53 @@
}

...
* Additionally, data collection will *never* happen if the system
     * property ro.com.google.enable_loc_code is not set.
*
...
// This class provides a Google-specific location feature, so it's enabled only
        // when the system property ro.com.google.enable_loc_code is set.
        if (!SystemProperties.get("ro.com.google.enable_loc_code").equals("1")) {
return false;
}

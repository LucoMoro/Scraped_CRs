/*Play original customized ringtone if default ringtone is unavailable

Make sure that original customized ringtone is played if the
current default ringtone is unavailable (f.ex. if sdcard is
removed). If the default tone becomes available again, it's
still kept as the default ringtone.
This also applies to notification and alarm defaults.

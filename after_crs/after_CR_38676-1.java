...
Change-Id:Ia04f69e85d8b7d7f4fc2421ae4c9839a3df914a0*/
...
//Synthetic comment -- index 71c635a..6316607 100644
...
private boolean isWindowsExecutable(IPath commandPath) {
        ...
        if (hasWindowsExecutableExtension(ext)) {
return true;
}
...
return false;
    ...
    private IPath appendExecutableExtension(IPath commandPath) {
        if (hasWindowsExecutableExtension(commandPath.getFileExtension())) {
            return commandPath;
        }

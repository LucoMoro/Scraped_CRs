...
//Synthetic comment -- index a0febeb..64ba4aa 100644
...
//Synthetic comment -- @@ -617,6 +628,79 @@
                ...
                try {
                    mCurrentDevice.executeShellCommand(command, new IShellOutputReceiver() {
                        ...
                        public void addOutput(byte[] data, int offset, int length) {
                            ...
                            Status status = new Status(IStatus.ERROR, //$NON-NLS-1$
                                    "DeviceExplorer", 0, errorMessage, null); //$NON-NLS-1$
                            ErrorDialog.openError(mTree.getShell(),
                                    "New Folder Error", "New Folder Error", status); //$NON-NLS-1$
                        }
                    });

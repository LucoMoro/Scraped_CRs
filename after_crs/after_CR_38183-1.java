...
//Synthetic comment -- index 88495e0..8499280 100644
...
//Synthetic comment -- @@ -88,29 +110,42 @@
mDescription = "";
}

        /** Returns th hardware config name of the property, e.g. "hw.screen" */
public String getName() {
return mName;
}
...
//Synthetic comment -- @@ -134,10 +169,10 @@
...
//Synthetic comment -- @@ -149,14 +184,41 @@
return null;
}
...
//Synthetic comment -- index d92e0fb..ab969ca 100644
        ...
        Set<Entry<String, HardwareProperty>> entries =
            new TreeSet<Map.Entry<String,HardwareProperty>>(
                ...
                public int compare(Entry<String, HardwareProperty> entry0,
                    ...
                    // Sort by display name if available. Otherwise by hardware name.

...
//Synthetic comment -- index 4d912b7..cc3d480 100644
...
int apiLevel, String codeName, String versionName, int revision) {
        ...
        mRootFolder = platformOSPath;
mProperties = Collections.unmodifiableMap(properties);
mVersion = new AndroidVersion(apiLevel, codeName);
mVersionName = versionName;
//Synthetic comment -- @@ -61,40 +72,45 @@
}

// pre-build the path to the platform components
        mPaths.put(ANDROID_JAR, mRootFolder + SdkConstants.FN_FRAMEWORK_LIBRARY);
        mPaths.put(SOURCES, mRootFolder + SdkConstants.FD_ANDROID_SOURCES);
        mPaths.put(ANDROID_AIDL, mRootFolder + SdkConstants.FN_FRAMEWORK_AIDL);
        mPaths.put(IMAGES, mRootFolder + SdkConstants.OS_IMAGES_FOLDER);
        mPaths.put(SAMPLES, mRootFolder + SdkConstants.OS_PLATFORM_SAMPLES_FOLDER);
        mPaths.put(SKINS, mRootFolder + SdkConstants.OS_SKINS_FOLDER);
        mPaths.put(TEMPLATES, mRootFolder + SdkConstants.OS_PLATFORM_TEMPLATES_FOLDER);
        mPaths.put(DATA, mRootFolder + SdkConstants.OS_PLATFORM_DATA_FOLDER);
        mPaths.put(ATTRIBUTES, mRootFolder + SdkConstants.OS_PLATFORM_ATTRS_XML);
        mPaths.put(MANIFEST_ATTRIBUTES, mRootFolder + SdkConstants.OS_PLATFORM_ATTRS_MANIFEST_XML);
        mPaths.put(RESOURCES, mRootFolder + SdkConstants.OS_PLATFORM_RESOURCES_FOLDER);
        mPaths.put(FONTS, mRootFolder + SdkConstants.OS_PLATFORM_FONTS_FOLDER);
        mPaths.put(LAYOUT_LIB, mRootFolder + SdkConstants.OS_PLATFORM_DATA_FOLDER +
SdkConstants.FN_LAYOUTLIB_JAR);
        mPaths.put(WIDGETS, mRootFolder + SdkConstants.OS_PLATFORM_DATA_FOLDER +
SdkConstants.FN_WIDGETS);
        mPaths.put(ACTIONS_ACTIVITY, mRootFolder + SdkConstants.OS_PLATFORM_DATA_FOLDER +
SdkConstants.FN_INTENT_ACTIONS_ACTIVITY);
        mPaths.put(ACTIONS_BROADCAST, mRootFolder + SdkConstants.OS_PLATFORM_DATA_FOLDER +
SdkConstants.FN_INTENT_ACTIONS_BROADCAST);
        mPaths.put(ACTIONS_SERVICE, mRootFolder + SdkConstants.OS_PLATFORM_DATA_FOLDER +
SdkConstants.FN_INTENT_ACTIONS_SERVICE);
        mPaths.put(CATEGORIES, mRootFolder + SdkConstants.OS_PLATFORM_DATA_FOLDER +
SdkConstants.FN_INTENT_CATEGORIES);
        mPaths.put(ANT, mRootFolder + SdkConstants.OS_PLATFORM_ANT_FOLDER);

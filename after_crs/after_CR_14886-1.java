...
//Synthetic comment -- index 9c3a8c5..a990149 100644

//Synthetic comment -- @@ -16,10 +16,14 @@
...
//Synthetic comment -- @@ -111,10 +111,6 @@
...
//Synthetic comment -- @@ -127,18 +123,49 @@
return mGlVersion;
}
...
public String toString() {
        ...
        write(sb, "outputname", mOutputName);
        write(sb, "buildinfo", mBuildInfo);
    ...
    public String getLogLine() {
        ...
        write(sb, "minor", mMinor);
        write(sb, "project", mRelativePath);
        write(sb, "api", mMinSdkVersion);

        if (mGlVersion != -1) {
            write(sb, "gl", mGlVersion);
        }
        ...
        write(sb, "screens", mSupportsScreens);

return sb.toString();
}
//Synthetic comment -- @@ -149,9 +176,11 @@
return minSdkDiff;
}
...
//Synthetic comment -- @@ -159,13 +188,17 @@
return 1;
}
...
//Synthetic comment -- @@ -173,79 +206,49 @@
}
...
*/
    ...
    private void setValues(Map<String, String> values) {
        mMinor = Integer.parseInt(values.get("minor"));
        mRelativePath = values.get("project");
        mMinSdkVersion = Integer.parseInt(values.get("api"));

        String tmp = values.get("gl");
        if (tmp != null) {
...
//Synthetic comment -- index 235e436..9b8a8c4 100644

...
//Synthetic comment -- index e088417..0f4efd2 100644

//Synthetic comment -- @@ -122,6 +122,15 @@
public AlarmManagerService(Context context) {
mContext = context;
mDescriptor = init();

        //We have to set current TimeZone info to kernel because kernel doesn't keep this after reboot.
        synchronized (this){
            TimeZone zone = TimeZone.getTimeZone(SystemProperties.get(TIMEZONE_PROPERTY));
            long current_date = Calendar.getInstance().getTimeInMillis();
            int gmtOffset = zone.getOffset(current_date) / 60000;

...
//Synthetic comment -- index 0000000..b4e73b6
...
new file mode 100644
//Synthetic comment -- index 0000000..16a6bba
...
//Synthetic comment -- index 17670e4..c2b403f 100644
...
@Override
public void run() {
//Synthetic comment -- @@ -536,6 +556,65 @@
}
};
        ...
        try {
            d.run(true, false, new IRunnableWithProgress() {
                ...
                public void run(IProgressMonitor monitor) throws InvocationTargetException,
                    ...
                    final SystraceOutputReceiver receiver = new SystraceOutputReceiver(
                            new SystraceHtmlWriter(new File(dlg.getTraceFilePath()),
...
//Synthetic comment -- @@ -635,8 +714,11 @@
}

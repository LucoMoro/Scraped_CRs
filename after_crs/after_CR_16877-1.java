...
if (result == BluetoothDevice.BOND_SUCCESS) {
            mBluetoothService.getBondState().setLocalInitiatedPairing(false);
...
if (propValues[1].equals("true")) {
                ...
                if (!mBluetoothService.getBondState().isLocalInitiatedPairing()) {
...
private String mPendingOutgoingBonding;
        ...
        private boolean mIsLocalInitiatedPairing = false;
...
//Synthetic comment -- @@ -629,6 +631,14 @@
        ...
        public synchronized boolean isLocalInitiatedPairing() {
            return mIsLocalInitiatedPairing;
        }

        public synchronized void setLocalInitiatedPairing(boolean isLocalInitiatedPairing) {
            mIsLocalInitiatedPairing = isLocalInitiatedPairing;
        }
...
return false;
        ...
        mBondState.setLocalInitiatedPairing(true);
...
return false;
        ...
        mBondState.setLocalInitiatedPairing(false);

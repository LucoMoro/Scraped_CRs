...
//Synthetic comment -- index 8044752..6a9e232 100644
...
//Synthetic comment -- @@ -46,4 +48,9 @@
assertEquals(message, "unknown", Build.CPU_ABI2);
}
}

    public void testDevice() {
        assertTrue("Build device may only have digits, lowercase letters, and underscores.",
                Pattern.matches("[0-9a-z_]+", Build.DEVICE));
    }
}

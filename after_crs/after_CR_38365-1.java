...
//Synthetic comment -- index cd80be2..fb2f0a6 100644

//Synthetic comment -- @@ -161,9 +161,19 @@
invalidateFeature));
}
        ...
        if (ni != null) {
            ...
            assertEquals(wifiOnlyStartFailureCode, mCm.startUsingNetworkFeature(TYPE_WIFI,
                    mmsFeature));
            assertEquals(wifiOnlyStopFailureCode, mCm.stopUsingNetworkFeature(TYPE_WIFI,
                    mmsFeature));
        }
}

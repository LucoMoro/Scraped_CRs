...
//Synthetic comment -- index 908c56b..5ea7028 100644
...
//Synthetic comment -- @@ -447,15 +451,17 @@
}
break;
case StatusCodes.FAILURE:
                Map<String, String> metrics = getAndResetTestMetrics();
...
getTrace(testInfo));
//Synthetic comment -- @@ -464,15 +470,17 @@
mNumTestsRun++;
break;
case StatusCodes.OK:
                metrics = getAndResetTestMetrics();

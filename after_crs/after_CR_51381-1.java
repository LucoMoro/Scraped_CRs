...
//Synthetic comment -- index 9da883a..8fabe6e 100644

//Synthetic comment -- @@ -379,7 +379,14 @@
...
if (mIsHwAccelerated) {
                try {
                    ...
                    Log.e(GL_LOG_TAG, "Error while drawing background with OpenGL: " + Log.getStackTraceString(e));
                    Log.e(TAG, "Switching back to redering with canvas.");

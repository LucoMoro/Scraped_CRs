...
/**
     * AsyncChannel constructor with source context and handler
     */
    public AsyncChannel(Context srcContext, Handler srcHandler) {
...
registerForNsdSetting();
            mReplyChannel = new AsyncChannel(mContext, getHandler());
        }

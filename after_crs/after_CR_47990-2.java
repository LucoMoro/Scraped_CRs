/*Fix bugs regarding StaleDataException during requerying an already closed cursor in CursorTreeAdapter.

When CursorTreeAdapter has an update in data, a related cursor is requeried.
But it might try to requery the already closed cursor, because there is no defence code for that.

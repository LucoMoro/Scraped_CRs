...
tabIndicator.setBackgroundResource(R.drawable.tab_indicator_v4);
                tv.setTextColor(R.color.tab_indicator_text_v4);
}
...
metrics.ydpi = ydpi;
            ...
            ProjectKeyWrapper projectKeyWrapper = new ProjectKeyWrapper(getApiLevel(), projectKey);
            context = new BridgeContext(projectKeyWrapper, metrics, currentTheme, projectResources,
...
//Synthetic comment -- @@ -1167,4 +1170,27 @@
    ...
    /**
     * Adds API level to the context
     *
     */
    public static final class ProjectKeyWrapper {

        private int mSdkVersion;
        private Object mProjectKey;

        public ProjectKeyWrapper(int sdkVersion, Object projectKey) {
            super();
...
IProjectCallback customViewLoader, ILayoutLog logger) {
        int sdkVersion = Build.VERSION_CODES.DONUT;
        if (projectKey instanceof Bridge.ProjectKeyWrapper) {
            mProjectKey = ((Bridge.ProjectKeyWrapper) projectKey).getProjectKey();
            sdkVersion = ((Bridge.ProjectKeyWrapper) projectKey).getSdkVersion();
        } else {
            mProjectKey = projectKey;
        }
        mApplicationInfo = new ApplicationInfo();
        mApplicationInfo.targetSdkVersion = sdkVersion;

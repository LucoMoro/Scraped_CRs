...
assertFalse(Density.INVALID_HIGH.equals(currentScreenConfig.getDensity()));
		...
		Log.d("testScreenLayoutSize", "currentScreenConfig.getDensity() is "+currentScreenConfig.getDensity());
		Log.d("testScreenLayoutSize", "current screen configuration is "+getCurrentScreenConfig());

...
//Synthetic comment -- index 7a9fc65..cfdbd44 100644
...
//Synthetic comment -- @@ -1515,7 +1524,20 @@
...
//Synthetic comment -- @@ -1624,7 +1646,10 @@
...
//Synthetic comment -- @@ -1757,6 +1782,7 @@
...
out.attribute(null, XML_ATTR_SYNC_RANDOM_OFFSET, Integer.toString(mSyncRandomOffset));
            ...
            out.attribute(null, "syncAutoDefault", Boolean.toString(mDefaultMasterSyncAutomatically));
// Write the Sync Automatically flags for each user
final int M = mMasterSyncAutomatically.size();
for (int m = 0; m < M; m++) {
//Synthetic comment -- @@ -1944,7 +1970,11 @@
...
name.length());
//Synthetic comment -- @@ -2289,4 +2319,30 @@
}
}
}

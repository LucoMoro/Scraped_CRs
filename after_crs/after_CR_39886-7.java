...
//Synthetic comment -- index 1f004f5..023f1cf 100644
...
//Synthetic comment -- @@ -324,9 +325,14 @@
...
IAndroidTarget projectTarget = currentSdk.getTarget(project);
        ...
        final int minApiLevel = ManifestInfo.get(project).getMinSdkVersion();
        final String minApiCodeName = ManifestInfo.get(project).getMinSdkCodeName();
...
//Synthetic comment -- @@ -370,17 +376,22 @@
...
//Synthetic comment -- @@ -416,38 +427,31 @@
...
//Synthetic comment -- @@ -634,22 +639,14 @@
/**

...
//Synthetic comment -- index 7aa0328..89b48aa 100644
...
//Synthetic comment -- @@ -1099,24 +986,122 @@
...
mCurrentRefresher = null;
            ...
            int currentItemCount = mTable.getItemCount();
            if (deletedCount > currentItemCount) {
                // if more entries than what is currently shown have been removed,
                // then remove all entries that are displayed, and then remove the remaining
                // entries from the start of the newly added messages.
                mTable.removeAll();
                for (int i = 0; i < deletedCount - currentItemCount; i++) {
...
//Synthetic comment -- @@ -1124,7 +1109,7 @@
...
//Synthetic comment -- @@ -1153,7 +1138,6 @@
...
//Synthetic comment -- @@ -1162,11 +1146,11 @@
...
//Synthetic comment -- @@ -1198,6 +1182,6 @@

...
//Synthetic comment -- index 9579bf5..a006733 100644
...
//Synthetic comment -- index 3acb01a..d86a9de 100644
...
//Synthetic comment -- index 0000000..0633505
...
public abstract class SdkManagerTestCase extends TestCase {
     ...
     */
    public File getAvdFolder(String avdName) throws AndroidLocationException {
        return new File(getAvdManager().getAvdRoot(), avdName);
    }
    ...
    protected static class TmpAvdManager extends AvdManager {
        ...
        /**
         * AVD Root, initialized "lazily" from {@link #getAvdRoot()}
        ...
        @Override
        protected File getAvdRoot() throws AndroidLocationException {
            if (mTmpAvdRoot == null) {
...
//Synthetic comment -- index 627bdb9..90e568c 100644
...
//Synthetic comment -- @@ -1004,17 +1006,17 @@
...
//Synthetic comment -- @@ -1033,12 +1035,12 @@
...
//Synthetic comment -- @@ -1405,23 +1407,38 @@
}

/**
     * Retrieves the AVD root to use.
     * This is typically based on the Android prefs location.
     *
     * Implementation detail: this method is protected since unit tests will typically
     * want to override this to locate the AVD root in a temp folder.
     *
     * @return The absolute path to the AVD root directory where to store AVD ini and data files.
     * @throws AndroidLocationException
     */
    protected File getAvdRoot() throws AndroidLocationException {
        return new File(AvdManager.getBaseAvdFolder());
    }

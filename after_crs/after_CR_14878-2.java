...
//Synthetic comment -- index 72014e4..b94d8ef 100644
...
// export.
//Synthetic comment -- @@ -243,30 +260,61 @@
...
"Codename in minSdkVersion is not supported by multi-apk export.");
            ...
            for (Manifest previousManifest : manifests) {
                ...
                if (minSdkVersion == previousManifest.data.getMinSdkVersion() &&
                    ...
                    throw new ExportException(String.format(
                            "Android manifests must differ in at least one of the following attribute:\n" +
                            "- minSdkVersion\n" +
                            "- SupportsScreen\n" +
                            "- GL ES version.\n" +
...
dataList.add(data);
//Synthetic comment -- @@ -301,15 +349,29 @@
}

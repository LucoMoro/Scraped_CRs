...
A property, ro.operator.displayUnicodeName, can be set
to override default behaviour and display operator name
as unicode is introduced.
...
//Synthetic comment -- index d539f6f1..95bac30 100644

//Synthetic comment -- @@ -589,11 +589,18 @@
if (rule != curSpnRule
|| !TextUtils.equals(spn, curSpn)
|| !TextUtils.equals(plmn, curPlmn)) {
            boolean showSpn = false;
            boolean showPlmn = false;
            if (SystemProperties.getBoolean("ro.operator.displayUnicodeName", false)) {
                showSpn = false;
                showPlmn = true;
                Log.d(LOG_TAG, "updateSpnDisplay: displaying unicode name");
            } else {

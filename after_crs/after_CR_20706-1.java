...
//Synthetic comment -- index 1349c23..56986ac 100755
...
Rect initialCrop = null;
                        ...
                        List<ViewInfo> viewInfoList = session.getRootView();
...
//Synthetic comment -- index ac60d80..d3138a3 100644
...
if (mIsResultValid && session != null) {
            ...
            List<ViewInfo> rootList = session.getRootView();
...
//Synthetic comment -- index a33a497..d4cca1c 100644
...
//Synthetic comment -- index 4db766d..3c59b20 100644
...
/**
     ...
     * <p/>
     * In most case the list will only contain one items. If the top level node is {@code merge}

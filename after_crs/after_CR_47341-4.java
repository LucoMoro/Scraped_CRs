/*Fix SDK 21 bug: Incorrect R.java generated by ant failed to build if lib and app has same package namehttp://code.google.com/p/android/issues/detail?id=40273Cause: seems the generation order is incorrect so the R.java of the app is overwritten by the library project's R.java.

Solution: change the order of generation for R.java so the app's R.java is generated after the library's.
...
old mode 100644
new mode 100755
//Synthetic comment -- index 2511500..e1d9ba7
...
try {
//Synthetic comment -- @@ -699,13 +696,12 @@

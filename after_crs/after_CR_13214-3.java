/*Refactored the proposed GLWallpaperService and GLSurfaceView so that they share a common codebase yet remain completely backwards-compatible.
...
//Synthetic comment -- diff --git a/core/java/android/service/wallpaper/GLWallpaperService.java b/core/java/android/service/wallpaper/GLWallpaperService.java
new file mode 100755
//Synthetic comment -- index 0000000..c4c6636

//Synthetic comment -- @@ -0,0 +1,461 @@
/*
...
//Synthetic comment -- diff --git a/opengl/java/android/opengl/EglHelper.java b/opengl/java/android/opengl/EglHelper.java
new file mode 100755
//Synthetic comment -- index 0000000..e626940

//Synthetic comment -- @@ -0,0 +1,981 @@
/*
 * Copyright (C) 2010 The Android Open Source Project
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
import android.service.wallpaper.GLWallpaperService;
...
//Synthetic comment -- diff --git a/opengl/java/android/opengl/GLRenderer.java b/opengl/java/android/opengl/GLRenderer.java
new file mode 100755
//Synthetic comment -- index 0000000..e20b7a8d

//Synthetic comment -- @@ -0,0 +1,119 @@
/*
 * Copyright (C) 2010 The Android Open Source Project
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//Synthetic comment -- diff --git a/opengl/java/android/opengl/GLSurfaceView.java b/opengl/java/android/opengl/GLSurfaceView.java
//Synthetic comment -- index 9ca57ba..74355cd 100644

//Synthetic comment -- @@ -16,55 +16,49 @@
...
*         if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER) {
*             queueEvent(new Runnable() {
//Synthetic comment -- @@ -134,56 +119,53 @@
*                 // thread:
*                 public void run() {
*                     mMyRenderer.handleDpadCenter();
 *                 }
...
super(context, attrs);
//Synthetic comment -- @@ -207,28 +189,27 @@
}
...
*/
public int getDebugFlags() {
//Synthetic comment -- @@ -245,20 +227,19 @@
}
...
* <li>{@link #getRenderMode()}
* <li>{@link #onPause()}
//Synthetic comment -- @@ -267,10 +248,11 @@
* <li>{@link #requestRender()}
* <li>{@link #setRenderMode(int)}
* </ul>
     * 
...
if (mEGLConfigChooser == null) {
mEGLConfigChooser = new SimpleEGLConfigChooser(true);
//Synthetic comment -- @@ -281,19 +263,17 @@
if (mEGLWindowSurfaceFactory == null) {
mEGLWindowSurfaceFactory = new DefaultWindowSurfaceFactory();
}
...
public void setEGLContextFactory(EGLContextFactory factory) {
checkRenderThreadState();
//Synthetic comment -- @@ -302,12 +282,10 @@
...
public void setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory factory) {
checkRenderThreadState();
//Synthetic comment -- @@ -316,13 +294,12 @@
...
*/
public void setEGLConfigChooser(EGLConfigChooser configChooser) {
//Synthetic comment -- @@ -331,17 +308,14 @@
}
...
*/
public void setEGLConfigChooser(boolean needDepth) {
//Synthetic comment -- @@ -349,36 +323,32 @@
}
...
* @see #RENDERMODE_CONTINUOUSLY
* @see #RENDERMODE_WHEN_DIRTY
//Synthetic comment -- @@ -398,27 +368,25 @@
}
...
//Synthetic comment -- @@ -426,48 +394,44 @@
}
...
//Synthetic comment -- @@ -475,36 +439,10 @@
...
/**
//Synthetic comment -- @@ -512,837 +450,30 @@
* <p>
* The renderer is responsible for making OpenGL calls to render a frame.
* <p>
     * GLSurfaceView clients typically create their own classes that implement this interface, and then call

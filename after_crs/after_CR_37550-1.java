...
//Synthetic comment -- index 0000000..e0cc281
...
public class FindDialog extends Dialog {
    ...
    private String mPreviousSearchText = null;
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        mSearchText.addModifyListener(new ModifyListener() {
            ...
            public void modifyText(ModifyEvent e) {
                boolean hasText = mSearchText.getText().trim().length() > 0;
...
//Synthetic comment -- index e2fb22f..f94c7b5 100644

//Synthetic comment -- @@ -1172,6 +1172,8 @@
...
//Synthetic comment -- @@ -1432,4 +1434,53 @@
mErrorColor.dispose();
...
new file mode 100644
//Synthetic comment -- index 0000000..ebefa36
...
public abstract class RollingBufferFindTarget implements IFindTarget {
    ...
    private Pattern mLastSearchPattern = null;

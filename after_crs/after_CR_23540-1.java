...
//Synthetic comment -- index c3698fd..baba1b7 100644
...
//Synthetic comment -- @@ -396,15 +403,49 @@
}
...
public ILayoutPullParser getParser(String layoutName) {
        ...
        if (mResourceResolver != null) {
            // This method is only called for project layouts, not framework layouts,
            // so we know that we should prefix with @layout, never @android:layout/
            String resource = LAYOUT_PREFIX + layoutName;
            ResourceValue value = mResourceResolver.findResValue(resource,
...
//Synthetic comment -- @@ -543,4 +584,13 @@

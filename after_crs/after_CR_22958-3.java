...
//Synthetic comment -- diff --git a/draw9patch/src/com/android/draw9patch/ui/NinePatchFileFilter.java b/draw9patch/src/com/android/draw9patch/ui/NinePatchFileFilter.java
new file mode 100644
//Synthetic comment -- index 0000000..979010b
...
class NinePatchFileFilter extends FileFilter {
    @Override
    public boolean accept(File f) {
        return f.isDirectory() || f.getName().toLowerCase().endsWith(".9.png");
    }

    @Override
    public String getDescription() {
        return "9-patch Image (*.9.png)";
    }
}

...
old mode 100644
new mode 100755
//Synthetic comment -- index 1a18a86..768d0a0

//Synthetic comment -- @@ -29,6 +29,7 @@
import android.webkit.CacheManager;
import android.webkit.WebView;
import android.webkit.CacheManager.CacheResult;
import android.webkit.WebChromeClient;										// to be added for waiver
...
mWebView = getActivity().getWebView();
		mWebView.setWebChromeClient(new WebChromeClient());					// to be added for waiver
}

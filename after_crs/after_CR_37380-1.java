...
//Synthetic comment -- index 2b02c59..b0845a7 100644

//Synthetic comment -- @@ -21,47 +21,41 @@
...
//Synthetic comment -- @@ -155,5 +143,28 @@
// nothing to be done here, we'll use the default value
}
}
...
//Synthetic comment -- index c35ad2f..c2f5132 100644
...
stopLaunch(launchInfo);
return false;
//Synthetic comment -- @@ -835,6 +903,36 @@
return true;
}
...
//Synthetic comment -- @@ -1154,7 +1252,7 @@
}
}
}
...
//Synthetic comment -- @@ -1167,10 +1265,17 @@
...
stopLaunch(info);
    ...
    private boolean doLaunchAction(final DelayedLaunchInfo info, IDevice device) {
        boolean success = info.getLaunchAction().doLaunchAction(info, device);
        if (success) {
...
//Synthetic comment -- index 99f582c..0e9d714 100644
...
gd.horizontalSpan = 2;
//Synthetic comment -- @@ -329,15 +376,35 @@
...
AvdManager avdManager = Sdk.getCurrent().getAvdManager();
        ...
        boolean multipleDevices =
                mode == TargetMode.ALL_DEVICES
             || mode == TargetMode.ALL_DEVICES_AND_EMULATORS
             || mode == TargetMode.ALL_EMULATORS;
...
//Synthetic comment -- @@ -466,13 +533,32 @@

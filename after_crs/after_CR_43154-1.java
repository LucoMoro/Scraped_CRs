...
/**
     * Defines the UID/GID for the diag group.
     * @hide
     */
    public static final int DIAG_UID = 2002;
...
private static final int LOG_UID = Process.LOG_UID;
    private static final int DIAG_UID = Process.DIAG_UID;
...
mSettings.addSharedUserLPw("android.uid.log", LOG_UID, ApplicationInfo.FLAG_SYSTEM);
        mSettings.addSharedUserLPw("android.uid.diag", DIAG_UID, ApplicationInfo.FLAG_SYSTEM);

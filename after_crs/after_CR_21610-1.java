...
StringBuilder sb = new StringBuilder();
        ...
        Image icon = elementDescriptor.getFormIcon();
if (icon != null) {
...
/**
     * Returns an optional icon for the element, to be used in XML forms.
     * <p/>
...
text.addHyperlinkListener(mTree.getEditor().createHyperlinkListener());
                    Image icon = elem_desc.getFormIcon();
if (icon != null) {

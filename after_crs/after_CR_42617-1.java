...
//Synthetic comment -- index c821dfc..e497871f 100644
...
//Synthetic comment -- index 4e62bca..54d6a80 100644
...
/**
//Synthetic comment -- @@ -100,6 +101,18 @@
...
//Synthetic comment -- @@ -110,6 +123,10 @@
...
//Synthetic comment -- index 27c844d..803f9e0 100644

//Synthetic comment -- @@ -244,7 +244,8 @@
case CLIENT_COL_NAME:
String name = cd.getClientDescription();
if (name != null) {
                            return cd.isValidUserId() ?
                                    String.format("%s (%d)", name, cd.getUserId()) : name;
}
return "?";
case CLIENT_COL_PID:

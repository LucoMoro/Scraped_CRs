...
public void setUp() {
      mDatabaseFile = new File(Environment.getExternalStorageDirectory(),
              "perf_database_test.db");
...
private static final String LOGTAG = "FsUtils";
    ...
    static final String HTTP_TESTS_PREFIX = EXTERNAL_DIR + "/android/layout_tests/http/tests/";
    static final String HTTPS_TESTS_PREFIX = EXTERNAL_DIR + "/android/layout_tests/http/tests/ssl/";
    static final String HTTP_LOCAL_TESTS_PREFIX = EXTERNAL_DIR + "/android/layout_tests/http/tests/local/";
    static final String HTTP_MEDIA_TESTS_PREFIX = EXTERNAL_DIR + "/android/layout_tests/http/tests/media/";
    static final String HTTP_WML_TESTS_PREFIX = EXTERNAL_DIR + "/android/layout_tests/http/tests/wml/";
...
try {
            ...
            File resultTimedoutFile = new File(externalDir, "layout_tests_timedout.txt");
...
private static final String PKG_NAME = "com.android.dumprendertree";
    ...
    private static final String TEST_LIST_FILE = EXTERNAL_DIR + "/android/reliability_tests_list.txt";
    private static final String TEST_STATUS_FILE = EXTERNAL_DIR + "/android/reliability_running_test.txt";
    private static final String TEST_TIMEOUT_FILE = EXTERNAL_DIR + "/android/reliability_timeout_test.txt";
    private static final String TEST_LOAD_TIME_FILE = EXTERNAL_DIR + "/android/reliability_load_time.txt";

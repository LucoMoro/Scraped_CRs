    ...
    private void initTargets() {
        ...
        if (currentSdk != null) {
            ...
            for (int i = 0 ; i < targets.length; i++) {
                // FIXME: support add-on rendering.
                if (mTarget != null && mTarget.canRunOn(targets[i]) &&
                        mTarget.isPlatform() == true) {
...
return null;
     ...
     *
     * @return an IAndroidTarget object or null if no target is setup or if the project has no
     * target set.
     *
     */

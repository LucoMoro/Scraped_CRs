...
// Failed to read XML document
            System.err.println("getXmlSchemaVersion exception: " + e.toString());
}
...
return result;
    ...
    private static InputStream toByteArrayInputStream(InputStream is) {
...
/**
 * Wraps an {@link InputStream} to change it's closing behavior:
 * this makes it possible ignore close operation or have them perform an
 * {@link InputStream#reset()} (if supported by the underlying stream)
 * or plain ignored.
 */

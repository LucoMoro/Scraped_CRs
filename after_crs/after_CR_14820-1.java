...
mTelephonyManager.getDeviceSoftwareVersion();
    ...
    /**
     * Use decimal value (0-9) to index into array to get sum of its digits needed by Lunh check.
     * Example: DOUBLE_DIGIT_SUM[6] = 3 because 6 * 2 = 12 => 1 + 2 = 3
     */
    private static final int[] DOUBLE_DIGIT_SUM = {0, 2, 4, 6, 8, 1, 3, 5, 7, 9};

    /**
     * Calculate the check digit by starting from the right, doubling every each digit, summing
     * all the digits including the doubled ones, and finding a number to make the sum divisble
     * by 10.
     *

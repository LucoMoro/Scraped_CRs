...
//Synthetic comment -- index cca6413..9c87deb 100644

//Synthetic comment -- @@ -155,8 +155,9 @@
Bitmap bitmap = null;
try {
SQLiteDatabase db = getReadableDatabase();
                String[] selectionArgs = { FIELD_APPWIDGET_ID, String.valueOf(appWidgetId) };
                c = db.query(TABLE_PHOTOS, PHOTOS_PROJECTION, "?=?", selectionArgs,
                        null, null, null, null);
...
SQLiteDatabase db = getWritableDatabase();
                String[] selectionArgs = { FIELD_APPWIDGET_ID, String.valueOf(appWidgetId) };
                db.delete(TABLE_PHOTOS, "?=?", selectionArgs);

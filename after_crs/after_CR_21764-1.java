...
* 2. Press '2' key and check if the content of TextView becomes "12"
     * 3. Press '3' key and check if the content of TextView becomes "123"
...
assertEquals("12", mTextView.getText().toString());
        ...
        assertEquals("123", mTextView.getText().toString());
...
assertEquals('0', mNumberKeyListener.lookup(event1, str));
        ...
        KeyEvent event2 = new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_P);
        str = new SpannableString("PBCD");
...
* 4. Press an unaccepted key if it exists and this key could not be entered.
     * 5. Press 'm' key and check if the content of TextView becomes "123m"
...
mInstrumentation.sendStringSync("m");
        assertEquals("123m", mTextView.getText().toString());
...
assertEquals("1", mTextView.getText().toString());
        ...
        // press 's' key.
        mInstrumentation.sendStringSync("s");
assertEquals("1", mTextView.getText().toString());

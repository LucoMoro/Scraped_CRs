...
//Synthetic comment -- index ba62403..a7e511f 100644

//Synthetic comment -- @@ -92,6 +92,12 @@
System.out.println("Android SDK Tools Revision " + toolsRevison);
        ...
        if (platformTools.isDirectory() == false) {
            throw new BuildException("SDK Platform Tools component is missing. Install it with the SDK Manager.");
        }
...
return false;
        ...
        if (checkFolder(platformTools) == false) {
            return errorHandler.handleError("SDK Platform Tools component is missing!\n" +
                    "Use the SDK Manager to download it.");
        }

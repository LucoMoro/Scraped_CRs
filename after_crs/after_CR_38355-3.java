...
//Synthetic comment -- index 645eb81..58d577a 100644
...
@Override
//Synthetic comment -- @@ -296,8 +300,16 @@
break;

case TelephonyManager.PHONE_TYPE_NONE:
                boolean nwSupported =
                    mConnectivityManager.isNetworkSupported(mConnectivityManager.TYPE_WIFI);
                if (nwSupported) {
                    assertSerialNumber();
                    assertMacAddressReported();
                } else {
                    nwSupported =
                        mConnectivityManager.isNetworkSupported(mConnectivityManager.TYPE_ETHERNET);

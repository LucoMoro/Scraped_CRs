...
//Synthetic comment -- index 0000000..a6e509a
...
new file mode 100644
//Synthetic comment -- index 0000000..e5cf665
...
public class DependencyGraph {
     ...
     */
    public void parseDependencyFile(String dependencyFilePath) {
        ...
        for (String path : prereqs) {
            ...
            if (preFile.toString().endsWith("AndroidManifest.xml") == false) {

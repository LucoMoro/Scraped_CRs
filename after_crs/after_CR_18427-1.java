...
//Synthetic comment -- index 4b3a3f3..6268cf9 100755

//Synthetic comment -- @@ -449,6 +449,9 @@
mReloadListener = null;
}

        if (mCanvasViewer != null && mCanvasViewer.getCanvas() != null) {
            mCanvasViewer.getCanvas().dispose();
        }
super.dispose();
}
...
//Synthetic comment -- index e945ba2..59ad215 100755
...
private Font mFont;
//Synthetic comment -- @@ -381,9 +381,15 @@
public void dispose() {
super.dispose();
...
//Synthetic comment -- index 5a7f631..98bc994 100755
...
//Synthetic comment -- @@ -160,6 +162,13 @@

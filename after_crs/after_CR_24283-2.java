...
EXCEPTION_PATTERNS.add("[0-9A-F]{6}7F:[0-9A-F]{4}"); // IPv4 Loopback
        EXCEPTION_PATTERNS.add("[0]{32}:0FC3"); // Motorola Mobility Inc. need to reserve this port for HTTP push.
        EXCEPTION_PATTERNS.add("[0]{32}:05ED");// Motorola Mobility Inc. need to reserve this port for AP/BP communication

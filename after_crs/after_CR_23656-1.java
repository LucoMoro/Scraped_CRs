...
//Synthetic comment -- index 3f48847..61dd0c2 100644
...
//Synthetic comment -- @@ -143,6 +144,15 @@
*/
public static final String ANDROID_PKG_PREFIX = ANDROID_PKG + '.';

    /** The android.view. package prefix */
    public static final String VIEW_PKG = ANDROID_PKG_PREFIX + "view."; //$NON-NLS-1$

    /** The android.widget. package prefix */
    public static final String WIDGET_PKG = ANDROID_PKG_PREFIX + "widget."; //$NON-NLS-1$

    /** The android.webkit. package prefix */
    public static final String WEBKIT_PKG = ANDROID_PKG_PREFIX + "webkit."; //$NON-NLS-1$
...
//Synthetic comment -- index b45a197..abb5069 100644

//Synthetic comment -- @@ -16,6 +16,10 @@

package com.android.ide.eclipse.adt.internal.editors.layout.descriptors;

import static com.android.ide.common.layout.LayoutConstants.VIEW_PKG;
import static com.android.ide.common.layout.LayoutConstants.WEBKIT_PKG;
import static com.android.ide.common.layout.LayoutConstants.WIDGET_PKG;
...
return icon;
    ...
    public static boolean viewNeedsPackage(String fqcn) {
        return !(fqcn.startsWith(WIDGET_PKG)
              || fqcn.startsWith(VIEW_PKG)
              || fqcn.startsWith(WEBKIT_PKG));
    }
}

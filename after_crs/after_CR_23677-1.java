...
values.put(AVD_INI_ABI_TYPE, abiType);
            ...
            // and the cpu arch.
            if (SdkConstants.ABI_ARMEABI.equals(abiType) || SdkConstants.ABI_ARMEABI_V7A.equals(abiType)) {
                ...
                log.error(null,
                        "ABI %1$s is not support by this version of the SDK Tools", abiType);
                needCleanup = true;
                return null;
            }
...
return mDescription;
        ...
        public boolean isValidForUi() {
            // don't show display type for now.

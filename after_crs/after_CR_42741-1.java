...
//Synthetic comment -- index e83601f..6b2da17 100644
...
System.exit(ERRNO_INVALIDARGS);
            ...
            System.err.println("The " + ARG_SOURCES + " and " + ARG_CLASSES + " and "
...
//Synthetic comment -- index 6b4ca31..4a9b0e0 100644
...
//Synthetic comment -- @@ -205,6 +204,101 @@
    ...
    public void testMultipleProjects() throws Exception {
        ...
        checkDriver(
        "",
        "The --sources and --classpath and --libraries arguments can only be used with a single project\n",

...
// Fallback to support pre-donuts releases
        int touchSlop, biggerTouchSlop, doubleTapSlop;
if (context == null) {
//noinspection deprecation
touchSlop = ViewConfiguration.getTouchSlop();
            biggerTouchSlop = ViewConfiguration.getBiggerTouchSlop();
...
touchSlop = configuration.getScaledTouchSlop();
            biggerTouchSlop = configuration.getScaledBiggerTouchSlop();
...
/**
     ...
     */
    private static final int BIGGER_TOUCH_SLOP = 18;
...
private final int mTouchSlop;
    private final int mBiggerTouchSlop;
...
mTouchSlop = TOUCH_SLOP;
        mBiggerTouchSlop = BIGGER_TOUCH_SLOP;
...
mTouchSlop = (int) (density * TOUCH_SLOP + 0.5f);
        mBiggerTouchSlop =  (int) (density * BIGGER_TOUCH_SLOP + 0.5f);
...
/**
     ...
     *         in a sequence of double tap
     *
     * @deprecated Use {@link #getScaledBiggerTouchSlop()} instead.
     */
    @Deprecated
    public static int getBiggerTouchSlop() {
        return BIGGER_TOUCH_SLOP;
    }
     ...
     *         in a sequence of double tap
     */
    public int getScaledBiggerTouchSlop() {
        return mBiggerTouchSlop;
    }

...
//Synthetic comment -- index fa73dbc..d3dd6a3 100644

//Synthetic comment -- @@ -19,10 +19,13 @@
...
//Synthetic comment -- @@ -106,7 +109,15 @@
...
store.setDefault(ATTR_HPROF_ACTION, HProfHandler.ACTION_SAVE);
        for (IContentType contentType: Platform.getContentTypeManager().getAllContentTypes()) {
            if (contentType.isAssociatedWith(DeviceView.HProfHandler.DOT_HPROF)) {

/*Throw more exceptions from Cursor classes
...
//Synthetic comment -- index 76b91f5..0685f1c 100644

//Synthetic comment -- @@ -236,7 +236,7 @@
* @param col the column to read from
* @return a String value for the given field
*/
    public byte[] getBlob(int row, int col) throws SQLException {
acquireReference();
try {
...
*/
    private native byte[] getBlob_native(int row, int col) throws SQLException;
...
* @return a String value for the given field
*/
    public String getString(int row, int col) throws SQLException {
acquireReference();
try {
...
*/
    private native String getString_native(int row, int col) throws SQLException;
...
* {@link SQLiteException} is thrown.
*/
    private native long getLong_native(int row, int col) throws SQLException;
...
* {@link SQLiteException} is thrown.
*/
    private native double getDouble_native(int row, int col) throws SQLException;
...
*/
    public short getShort(int row, int col) throws SQLException {
acquireReference();
try {
...
//Synthetic comment -- @@ -489,7 +489,7 @@
* @param col the column to read from
* @return a float value for the given field
*/
    public float getFloat(int row, int col) throws SQLException {
acquireReference();
try {

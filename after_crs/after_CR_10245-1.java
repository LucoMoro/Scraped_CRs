...
private static final int MENU_ADD_TO_CONTACTS      = 3;
    ...
    private static final int COLUMN_PRESENCE_HANDLE = 0;
    private static final int COLUMN_PRESENCE_PROTOCOL = 1;
    
    private static final String IM_CONTENT_TYPE = "imto://";
...
Presence.PERSON_ID + "=" + info.person_id, null, null);    
            ...
            //Just grab the first presence provider
            if (presenceCursor != null && presenceCursor.moveToNext()) {
                // Find the display info for the provider
                String data = presenceCursor.getString(COLUMN_PRESENCE_HANDLE);

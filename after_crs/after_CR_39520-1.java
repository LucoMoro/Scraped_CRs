...
//Synthetic comment -- index 2da1fb5..6ba9b05 100644
...
//Synthetic comment -- @@ -318,6 +328,38 @@
}
    ...
    private static void requireJdk6(IProject project) throws CoreException {
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            for (int j = 0; j < installs.length; j++) {
                ...
                IVMInstall2 vmInstall2 = (IVMInstall2) install;
                if (JavaCore.VERSION_1_6.equals(vmInstall2.getJavaVersion())) {
                    haveJdk6 = true;
                }
            }
        }

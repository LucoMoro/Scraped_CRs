...
if (expected == null) {
            File expectedPath = new File(getTargetDir(), expectedName);
...
//Synthetic comment -- @@ -349,6 +391,27 @@
    ...
    protected File getTargetDir() {
        ...
        // will be created directly into the test data directory and you can rerun the test
        ...
        if (sdk != null) {
            ...
            if (sdkPath.exists()) {
                File testData = new File(sdkPath,
                        TEST_DATA_REL_PATH.replace('/', File.separatorChar));
                if (testData.exists()) {
                    return testData;
                }
            }

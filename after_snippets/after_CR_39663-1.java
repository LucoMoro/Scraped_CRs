...
public class DeviceCreationDialog extends GridDialog {
    ...
    private Button mOrientation; // hw.sensors.orientation, actually a gyro
    ...
    public void createDialogContent(Composite parent) {
        ...
        mOrientation = generateButton(sensorGroup, "Orientation",
                "Presence of an orientation sensor", SWT.CHECK, true, validator);
    ...
    private class KeyboardListener extends SelectionAdapter {
        ...
        public void widgetSelected(SelectionEvent event) {
            ...
            if (mKeyboard.getSelection()) {
                ...
                mPortraitKeysNav.setEnabled(mPortraitKeys.getSelection());
    ...
    private void prefillWithDevice(@Nullable Device device) {
        ...
        mOrientation.setSelection(mHardware.getSensors().contains(Sensor.GYROSCOPE));
